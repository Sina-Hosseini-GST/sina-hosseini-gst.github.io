...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function oc(){return new Ii({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Do(),fragmentShader:`
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function lc(){return new Ii({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Do(),fragmentShader:`
	...
	`}function c_(r){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===no||l===io,u=l===vr||l===xr;if(c||u)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let h=e.get(a);return t===null&&(t=new sc(r)),h=c?t.fromEquirectangular(a,h):t.fromCubemap(a,h),e.set(a,h),h.texture}else{if(e.has(a))return e.get(a).texture;{const h=a.image;if(c&&h&&h.height>0||u&&h&&i(h)){t===null&&(t=new sc(r));const f=c?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,f),a.addEventListener("dispose",s),f.texture}else return null}}}return a}function i(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function u_(r){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?t("EXT_color_buffer_float"):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const i=t(n);return i===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function h_(r,e,t,n){const i={},s=new WeakMap;function o(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let p=0,d=_.length;p<d;p++)e.remove(_[p])}f.removeEventListener("dispose",o),delete i[f.id];const m=s.get(f);m&&(e.remove(m),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function a(h,f){return i[f.id]===!0||(f.addEventListener("dispose",o),i[f.id]=!0,t.memory.geometries++),f}function l(h){const f=h.attributes;for(const g in f)e.update(f[g],r.ARRAY_BUFFER);const m=h.morphAttributes;for(const g in m){const _=m[g];for(let p=0,d=_.length;p<d;p++)e.update(_[p],r.ARRAY_BUFFER)}}function c(h){const f=[],m=h.index,g=h.attributes.position;let _=0;if(m!==null){const E=m.array;_=m.version;for(let x=0,S=E.length;x<S;x+=3){const y=E[x+0],R=E[x+1],b=E[x+2];f.push(y,R,R,b,b,y)}}else if(g!==void 0){const E=g.array;_=g.version;for(let x=0,S=E.length/3-1;x<S;x+=3){const y=x+0,R=x+1,b=x+2;f.push(y,R,R,b,b,y)}}else return;const p=new(au(f)?pu:du)(f,1);p.version=_;const d=s.get(h);d&&e.remove(d),s.set(h,p)}function u(h){const f=s.get(h);if(f){const m=h.index;m!==null&&f.version<m.version&&c(h)}else c(h);return s.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function f_(r,e,t,n){const i=n.isWebGL2;let s;function o(f){s=f}let a,l;function c(f){a=f.type,l=f.bytesPerElement}function u(f,m){r.drawElements(s,m,a,f*l),t.update(m,s,1)}function h(f,m,g){if(g===0)return;let _,p;if(i)_=r,p="drawElementsInstanced";else if(_=e.get("ANGLE_instanced_arrays"),p="drawElementsInstancedANGLE",_===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}_[p](s,m,a,f*l,g),t.update(m,s,g)}this.setMode=o,this.setIndex=c,this.render=u,this.renderInstances=h}function d_(r){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case r.TRIANGLES:t.triangles+=a*(s/3);break;case r.LINES:t.lines+=a*(s/2);break;case r.LINE_STRIP:t.lines+=a*(s-1);break;case r.LINE_LOOP:t.lines+=a*s;break;case r.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function p_(r,e){return r[0]-e[0]}function m_(r,e){return Math.abs(e[1])-Math.abs(r[1])}function __(r,e,t){const n={},i=new Float32Array(8),s=new WeakMap,o=new Et,a=[];for(let c=0;c<8;c++)a[c]=[c,0];function l(c,u,h){const f=c.morphTargetInfluences;if(e.isWebGL2===!0){const g=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,_=g!==void 0?g.length:0;let p=s.get(u);if(p===void 0||p.count!==_){let O=function(){j.dispose(),s.delete(u),u.removeEventListener("dispose",O)};var m=O;p!==void 0&&p.texture.dispose();const x=u.morphAttributes.position!==void 0,S=u.morphAttributes.normal!==void 0,y=u.morphAttributes.color!==void 0,R=u.morphAttributes.position||[],b=u.morphAttributes.normal||[],D=u.morphAttributes.color||[];let v=0;x===!0&&(v=1),S===!0&&(v=2),y===!0&&(v=3);let A=u.attributes.position.count*v,z=1;A>e.maxTextureSize&&(z=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const q=new Float32Array(A*z*4*_),j=new cu(q,A,z,_);j.type=Kn,j.needsUpdate=!0;const P=v*4;for(let X=0;X<_;X++){const k=R[X],J=b[X],$=D[X],K=A*z*4*X;for(let U=0;U<k.count;U++){const H=U*P;x===!0&&(o.fromBufferAttribute(k,U),q[K+H+0]=o.x,q[K+H+1]=o.y,q[K+H+2]=o.z,q[K+H+3]=0),S===!0&&(o.fromBufferAttribute(J,U),q[K+H+4]=o.x,q[K+H+5]=o.y,q[K+H+6]=o.z,q[K+H+7]=0),y===!0&&(o.fromBufferAttribute($,U),q[K+H+8]=o.x,q[K+H+9]=o.y,q[K+H+10]=o.z,q[K+H+11]=$.itemSize===4?o.w:1)}}p={count:_,texture:j,size:new ze(A,z)},s.set(u,p),u.addEventListener("dispose",O)}let d=0;for(let x=0;x<f.length;x++)d+=f[x];const E=u.morphTargetsRelative?1:1-d;h.getUniforms().setValue(r,"morphTargetBaseInfluence",E),h.getUniforms().setValue(r,"morphTargetInfluences",f),h.getUniforms().setValue(r,"morphTargetsTexture",p.texture,t),h.getUniforms().setValue(r,"morphTargetsTextureSize",p.size)}else{const g=f===void 0?0:f.length;let _=n[u.id];if(_===void 0||_.length!==g){_=[];for(let S=0;S<g;S++)_[S]=[S,0];n[u.id]=_}for(let S=0;S<g;S++){const y=_[S];y[0]=S,y[1]=f[S]}_.sort(m_);for(let S=0;S<8;S++)S<g&&_[S][1]?(a[S][0]=_[S][0],a[S][1]=_[S][1]):(a[S][0]=Number.MAX_SAFE_INTEGER,a[S][1]=0);a.sort(p_);const p=u.morphAttributes.position,d=u.morphAttributes.normal;let E=0;for(let S=0;S<8;S++){const y=a[S],R=y[0],b=y[1];R!==Number.MAX_SAFE_INTEGER&&b?(p&&u.getAttribute("morphTarget"+S)!==p[R]&&u.setAttribute("morphTarget"+S,p[R]),d&&u.getAttribute("morphNormal"+S)!==d[R]&&u.setAttribute("morphNormal"+S,d[R]),i[S]=b,E+=b):(p&&u.hasAttribute("morphTarget"+S)===!0&&u.deleteAttribute("morphTarget"+S),d&&u.hasAttribute("morphNormal"+S)===!0&&u.deleteAttribute("morphNormal"+S),i[S]=0)}const x=u.morphTargetsRelative?1:1-E;h.getUniforms().setValue(r,"morphTargetBaseInfluence",x),h.getUniforms().setValue(r,"morphTargetInfluences",i)}}return{update:l}}function g_(r,e,t,n){let i=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(i.get(h)!==c&&(e.update(h),i.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(t.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;i.get(f)!==c&&(f.update(),i.set(f,c))}return h}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}const Mu=new zt,Su=new cu,Eu=new nd,yu=new gu,cc=[],uc=[],hc=new Float32Array(16),fc=new Float32Array(9),dc=new Float32Array(4);function Cr(r,e,t){const n=r[0];if(n<=0||n>0)return r;const i=e*t;let s=cc[i];if(s===void 0&&(s=new Float32Array(i),cc[i]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,r[o].toArray(s,a)}return s}function dt(r,e){if(r.length!==e.length)return!1;for(let t=0,n=r.length;t<n;t++)if(r[t]!==e[t])return!1;return!0}function pt(r,e){for(let t=0,n=e.length;t<n;t++)r[t]=e[t]}function oa(r,e){let t=uc[e];t===void 0&&(t=new Int32Array(e),uc[e]=t);for(let n=0;n!==e;++n)t[n]=r.allocateTextureUnit();return t}function v_(r,e){const t=this.cache;t[0]!==e&&(r.uniform1f(this.addr,e),t[0]=e)}function x_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dt(t,e))return;r.uniform2fv(this.addr,e),pt(t,e)}}function M_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(dt(t,e))return;r.uniform3fv(this.addr,e),pt(t,e)}}function S_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dt(t,e))return;r.uniform4fv(this.addr,e),pt(t,e)}}function E_(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(dt(t,e))return;r.uniformMatrix2fv(this.addr,!1,e),pt(t,e)}else{if(dt(t,n))return;dc.set(n),r.uniformMatrix2fv(this.addr,!1,dc),pt(t,n)}}function y_(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(dt(t,e))return;r.uniformMatrix3fv(this.addr,!1,e),pt(t,e)}else{if(dt(t,n))return;fc.set(n),r.uniformMatrix3fv(this.addr,!1,fc),pt(t,n)}}function T_(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(dt(t,e))return;r.uniformMatrix4fv(this.addr,!1,e),pt(t,e)}else{if(dt(t,n))return;hc.set(n),r.uniformMatrix4fv(this.addr,!1,hc),pt(t,n)}}function b_(r,e){const t=this.cache;t[0]!==e&&(r.uniform1i(this.addr,e),t[0]=e)}function A_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dt(t,e))return;r.uniform2iv(this.addr,e),pt(t,e)}}function w_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(dt(t,e))return;r.uniform3iv(this.addr,e),pt(t,e)}}function R_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dt(t,e))return;r.uniform4iv(this.addr,e),pt(t,e)}}function C_(r,e){const t=this.cache;t[0]!==e&&(r.uniform1ui(this.addr,e),t[0]=e)}function P_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(dt(t,e))return;r.uniform2uiv(this.addr,e),pt(t,e)}}function L_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(dt(t,e))return;r.uniform3uiv(this.addr,e),pt(t,e)}}function D_(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(dt(t,e))return;r.uniform4uiv(this.addr,e),pt(t,e)}}function U_(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture2D(e||Mu,i)}function I_(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||Eu,i)}function N_(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||yu,i)}function O_(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||Su,i)}function F_(r){switch(r){case 5126:return v_;case 35664:return x_;case 35665:return M_;case 35666:return S_;case 35674:return E_;case 35675:return y_;case 35676:return T_;case 5124:case 35670:return b_;case 35667:case 35671:return A_;case 35668:case 35672:return w_;case 35669:case 35673:return R_;case 5125:return C_;case 36294:return P_;case 36295:return L_;case 36296:return D_;case 35678:case 36198:case 36298:case 36306:case 35682:return U_;case 35679:case 36299:case 36307:return I_;case 35680:case 36300:case 36308:case 36293:return N_;case 36289:case 36303:case 36311:case 36292:return O_}}function B_(r,e){r.uniform1fv(this.addr,e)}function z_(r,e){const t=Cr(e,this.size,2);r.uniform2fv(this.addr,t)}function G_(r,e){const t=Cr(e,this.size,3);r.uniform3fv(this.addr,t)}function H_(r,e){const t=Cr(e,this.size,4);r.uniform4fv(this.addr,t)}function k_(r,e){const t=Cr(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,t)}function V_(r,e){const t=Cr(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,t)}function W_(r,e){const t=Cr(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,t)}function X_(r,e){r.uniform1iv(this.addr,e)}function q_(r,e){r.uniform2iv(this.addr,e)}function Y_(r,e){r.uniform3iv(this.addr,e)}function j_(r,e){r.uniform4iv(this.addr,e)}function K_(r,e){r.uniform1uiv(this.addr,e)}function Z_(r,e){r.uniform2uiv(this.addr,e)}function $_(r,e){r.uniform3uiv(this.addr,e)}function J_(r,e){r.uniform4uiv(this.addr,e)}function Q_(r,e,t){const n=this.cache,i=e.length,s=oa(t,i);dt(n,s)||(r.uniform1iv(this.addr,s),pt(n,s));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||Mu,s[o])}function eg(r,e,t){const n=this.cache,i=e.length,s=oa(t,i);dt(n,s)||(r.uniform1iv(this.addr,s),pt(n,s));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||Eu,s[o])}function tg(r,e,t){const n=this.cache,i=e.length,s=oa(t,i);dt(n,s)||(r.uniform1iv(this.addr,s),pt(n,s));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||yu,s[o])}function ng(r,e,t){const n=this.cache,i=e.length,s=oa(t,i);dt(n,s)||(r.uniform1iv(this.addr,s),pt(n,s));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||Su,s[o])}function ig(r){switch(r){case 5126:return B_;case 35664:return z_;case 35665:return G_;case 35666:return H_;case 35674:return k_;case 35675:return V_;case 35676:return W_;case 5124:case 35670:return X_;case 35667:case 35671:return q_;case 35668:case 35672:return Y_;case 35669:case 35673:return j_;case 5125:return K_;case 36294:return Z_;case 36295:return $_;case 36296:return J_;case 35678:case 36198:case 36298:case 36306:case 35682:return Q_;case 35679:case 36299:case 36307:return eg;case 35680:case 36300:case 36308:case 36293:return tg;case 36289:case 36303:case 36311:case 36292:return ng}}class rg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.setValue=F_(t.type)}}class sg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.size=t.size,this.setValue=ig(t.type)}}class ag{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let s=0,o=i.length;s!==o;++s){const a=i[s];a.setValue(e,t[a.id],n)}}}const ka=/(\w+)(\])?(\[|\.)?/g;function pc(r,e){r.seq.push(e),r.map[e.id]=e}function og(r,e,t){const n=r.name,i=n.length;for(ka.lastIndex=0;;){const s=ka.exec(n),o=ka.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){pc(t,c===void 0?new rg(a,r,e):new sg(a,r,e));break}else{let h=t.map[a];h===void 0&&(h=new ag(a),pc(t,h)),t=h}}}class Ns{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=e.getActiveUniform(t,i),o=e.getUniformLocation(t,s.name);og(s,o,this)}}setValue(e,t,n,i){const s=this.map[t];s!==void 0&&s.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,s=e.length;i!==s;++i){const o=e[i];o.id in t&&n.push(o)}return n}}function mc(r,e,t){const n=r.createShader(e);return r.shaderSource(n,t),r.compileShader(n),n}const lg=37297;let cg=0;function ug(r,e){const t=r.split(`
`),n=[],i=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=i;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function hg(r){const e=qe.getPrimaries(qe.workingColorSpace),t=qe.getPrimaries(r);let n;switch(e===t?n="":e===Vs&&t===ks?n="LinearDisplayP3ToLinearSRGB":e===ks&&t===Vs&&(n="LinearSRGBToLinearDisplayP3"),r){case zn:case ia:return[n,"LinearTransferOETF"];case Mt:case Ro:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",r),[n,"LinearTransferOETF"]}}function _c(r,e,t){const n=r.getShaderParameter(e,r.COMPILE_STATUS),i=r.getShaderInfoLog(e).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+i+`

`+ug(r.getShaderSource(e),o)}else return i}function fg(r,e){const t=hg(e);return`vec4 ${r}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function dg(r,e){let t;switch(e){case cf:t="Linear";break;case uf:t="Reinhard";break;case hf:t="OptimizedCineon";break;case ff:t="ACESFilmic";break;case df:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function pg(r){return[r.extensionDerivatives||r.envMapCubeUVHeight||r.bumpMap||r.normalMapTangentSpace||r.clearcoatNormalMap||r.flatShading||r.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(r.extensionFragDepth||r.logarithmicDepthBuffer)&&r.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",r.extensionDrawBuffers&&r.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(r.extensionShaderTextureLOD||r.envMap||r.transmission)&&r.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Or).join(`
`)}function mg(r){const e=[];for(const t in r){const n=r[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function _g(r,e){const t={},n=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(e,i),o=s.name;let a=1;s.type===r.FLOAT_MAT2&&(a=2),s.type===r.FLOAT_MAT3&&(a=3),s.type===r.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:r.getAttribLocation(e,o),locationSize:a}}return t}function Or(r){return r!==""}function gc(r,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function vc(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const gg=/^[ \t]*#include +<([\w\d./]+)>/gm;function lo(r){return r.replace(gg,xg)}const vg=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function xg(r,e){let t=Oe[e];if(t===void 0){const n=vg.get(e);if(n!==void 0)t=Oe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return lo(t)}const Mg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function xc(r){return r.replace(Mg,Sg)}function Sg(r,e,t,n){let i="";for(let s=parseInt(e);s<parseInt(t);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Mc(r){let e="precision "+r.precision+` float;
precision `+r.precision+" int;";return r.precision==="highp"?e+=`
#define HIGH_PRECISION`:r.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:r.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Eg(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Zc?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===Oh?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===In&&(e="SHADOWMAP_TYPE_VSM"),e}function yg(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case vr:case xr:e="ENVMAP_TYPE_CUBE";break;case na:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Tg(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case xr:e="ENVMAP_MODE_REFRACTION";break}return e}function bg(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case $c:e="ENVMAP_BLENDING_MULTIPLY";break;case of:e="ENVMAP_BLENDING_MIX";break;case lf:e="ENVMAP_BLENDING_ADD";break}return e}function Ag(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function wg(r,e,t,n){const i=r.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Eg(t),c=yg(t),u=Tg(t),h=bg(t),f=Ag(t),m=t.isWebGL2?"":pg(t),g=mg(s),_=i.createProgram();let p,d,E=t.glslVersion?"#version "+t.glslVersion+`
...
*/var $t={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},Er={duration:.5,overwrite:!1,delay:0},Io,Ct,it,ln=1e8,Ke=1/ln,co=Math.PI*2,u0=co/4,h0=0,Au=Math.sqrt,f0=Math.cos,d0=Math.sin,xt=function(e){return typeof e=="string"},rt=function(e){return typeof e=="function"},Gn=function(e){return typeof e=="number"},No=function(e){return typeof e>"u"},wn=function(e){return typeof e=="object"},Gt=function(e){return e!==!1},Oo=function(){return typeof window<"u"},Is=function(e){return rt(e)||xt(e)},wu=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},Pt=Array.isArray,uo=/(?:-?\.?\d|\.)+/gi,Ru=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,or=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Xa=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Cu=/[+-]=-?[.\d]+/,Pu=/[^,'"\[\]\s]+/gi,p0=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,et,nn,ho,Fo,Jt={},qs={},Lu,Du=function(e){return(qs=Ni(e,Jt))&&Vt},Bo=function(e,t){return console.warn("Invalid property",e,"set to",t,"Missing plugin? gsap.registerPlugin()")},Ys=function(e,t){return!t&&console.warn(e)},Uu=function(e,t){return e&&(Jt[e]=t)&&qs&&(qs[e]=t)||Jt},Zr=function(){return 0},m0={suppressEvents:!0,isStart:!0,kill:!1},Os={suppressEvents:!0,kill:!1},_0={suppressEvents:!0},zo={},ni=[],fo={},Iu,jt={},qa={},Pc=30,Fs=[],Go="",Ho=function(e){var t=e[0],n,i;if(wn(t)||rt(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(i=Fs.length;i--&&!Fs[i].targetTest(t););n=Fs[i]}for(i=e.length;i--;)e[i]&&(e[i]._gsap||(e[i]._gsap=new rh(e[i],n)))||e.splice(i,1);return e},wi=function(e){return e._gsap||Ho(cn(e))[0]._gsap},Nu=function(e,t,n){return(n=e[t])&&rt(n)?e[t]():No(n)&&e.getAttribute&&e.getAttribute(t)||n},Ht=function(e,t){return(e=e.split(",")).forEach(t)||e},ot=function(e){return Math.round(e*1e5)/1e5||0},St=function(e){return Math.round(e*1e7)/1e7||0},mr=function(e,t){var n=t.charAt(0),i=parseFloat(t.substr(2));return e=parseFloat(e),n==="+"?e+i:n==="-"?e-i:n==="*"?e*i:e/i},g0=function(e,t){for(var n=t.length,i=0;e.indexOf(t[i])<0&&++i<n;);return i<n},js=function(){var e=ni.length,t=ni.slice(0),n,i;for(fo={},ni.length=0,n=0;n<e;n++)i=t[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},Ou=function(e,t,n,i){ni.length&&!Ct&&js(),e.render(t,n,i||Ct&&t<0&&(e._initted||e._startAt)),ni.length&&!Ct&&js()},Fu=function(e){var t=parseFloat(e);return(t||t===0)&&(e+"").match(Pu).length<2?t:xt(e)?e.trim():e},Bu=function(e){return e},hn=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},v0=function(e){return function(t,n){for(var i in n)i in t||i==="duration"&&e||i==="ease"||(t[i]=n[i])}},Ni=function(e,t){for(var n in t)e[n]=t[n];return e},Lc=function r(e,t){for(var n in t)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(e[n]=wn(t[n])?r(e[n]||(e[n]={}),t[n]):t[n]);return e},Ks=function(e,t){var n={},i;for(i in e)i in t||(n[i]=e[i]);return n},kr=function(e){var t=e.parent||et,n=e.keyframes?v0(Pt(e.keyframes)):hn;if(Gt(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},x0=function(e,t){for(var n=e.length,i=n===t.length;i&&n--&&e[n]===t[n];);return n<0},zu=function(e,t,n,i,s){n===void 0&&(n="_first"),i===void 0&&(i="_last");var o=e[i],a;if(s)for(a=t[s];o&&o[s]>a;)o=o._prev;return o?(t._next=o._next,o._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[i]=t,t._prev=o,t.parent=t._dp=e,t},la=function(e,t,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=t._prev,o=t._next;s?s._next=o:e[n]===t&&(e[n]=o),o?o._prev=s:e[i]===t&&(e[i]=s),t._next=t._prev=t.parent=null},si=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},Ri=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},M0=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},po=function(e,t,n,i){return e._startAt&&(Ct?e._startAt.revert(Os):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,i))},S0=function r(e){return!e||e._ts&&r(e.parent)},Dc=function(e){return e._repeat?yr(e._tTime,e=e.duration()+e._rDelay)*e:0},yr=function(e,t){var n=Math.floor(e/=t);return e&&n===e?n-1:n},Zs=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},ca=function(e){return e._end=St(e._start+(e._tDur/Math.abs(e._ts||e._rts||Ke)||0))},ua=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=St(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),ca(e),n._dirty||Ri(n,e)),e},Gu=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=Zs(e.rawTime(),t),(!t._dur||ls(0,t.totalDuration(),n)-t._tTime>Ke)&&t.render(n,!0)),Ri(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-Ke}},yn=function(e,t,n,i){return t.parent&&si(t),t._start=St((Gn(n)?n:n||e!==et?tn(e,n,t):e._time)+t._delay),t._end=St(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),zu(e,t,"_first","_last",e._sort?"_start":0),mo(t)||(e._recent=t),i||Gu(e,t),e._ts<0&&ua(e,e._tTime),e},Hu=function(e,t){return(Jt.ScrollTrigger||Bo("scrollTrigger",t))&&Jt.ScrollTrigger.create(t,e)},ku=function(e,t,n,i,s){if(Vo(e,t,s),!e._initted)return 1;if(!n&&e._pt&&!Ct&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&Iu!==Kt.frame)return ni.push(e),e._lazy=[s,i],1},E0=function r(e){var t=e.parent;return t&&t._ts&&t._initted&&!t._lock&&(t.rawTime()<0||r(t))},mo=function(e){var t=e.data;return t==="isFromStart"||t==="isStart"},y0=function(e,t,n,i){var s=e.ratio,o=t<0||!t&&(!e._start&&E0(e)&&!(!e._initted&&mo(e))||(e._ts<0||e._dp._ts<0)&&!mo(e))?0:1,a=e._rDelay,l=0,c,u,h;if(a&&e._repeat&&(l=ls(0,e._tDur,t),u=yr(l,a),e._yoyo&&u&1&&(o=1-o),u!==yr(e._tTime,a)&&(s=1-o,e.vars.repeatRefresh&&e._initted&&e.invalidate())),o!==s||Ct||i||e._zTime===Ke||!t&&e._zTime){if(!e._initted&&ku(e,t,i,n,l))return;for(h=e._zTime,e._zTime=t||(n?Ke:0),n||(n=t&&!h),e.ratio=o,e._from&&(o=1-o),e._time=0,e._tTime=l,c=e._pt;c;)c.r(o,c.d),c=c._next;t<0&&po(e,t,n,!0),e._onUpdate&&!n&&un(e,"onUpdate"),l&&e._repeat&&!n&&e.parent&&un(e,"onRepeat"),(t>=e._tDur||t<0)&&e.ratio===o&&(o&&si(e,1),!n&&!Ct&&(un(e,o?"onComplete":"onReverseComplete",!0),e._prom&&e._prom()))}else e._zTime||(e._zTime=t)},T0=function(e,t,n){var i;if(n>t)for(i=e._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>t)return i;i=i._next}else for(i=e._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<t)return i;i=i._prev}},Tr=function(e,t,n,i){var s=e._repeat,o=St(t)||0,a=e._tTime/e._tDur;return a&&!i&&(e._time*=o/e._dur),e._dur=o,e._tDur=s?s<0?1e10:St(o*(s+1)+e._rDelay*s):o,a>0&&!i&&ua(e,e._tTime=e._tDur*a),e.parent&&ca(e),n||Ri(e.parent,e),e},Uc=function(e){return e instanceof Ft?Ri(e):Tr(e,e._dur)},b0={_start:0,endTime:Zr,totalDuration:Zr},tn=function r(e,t,n){var i=e.labels,s=e._recent||b0,o=e.duration()>=ln?s.endTime(!1):e._dur,a,l,c;return xt(t)&&(isNaN(t)||t in i)?(l=t.charAt(0),c=t.substr(-1)==="%",a=t.indexOf("="),l==="<"||l===">"?(a>=0&&(t=t.replace(/=/,"")),(l==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(t.substr(1))||0)*(c?(a<0?s:n).totalDuration()/100:1)):a<0?(t in i||(i[t]=o),i[t]):(l=parseFloat(t.charAt(a-1)+t.substr(a+1)),c&&n&&(l=l/100*(Pt(n)?n[0]:n).totalDuration()),a>1?r(e,t.substr(0,a-1),n)+l:o+l)):t==null?o:+t},Vr=function(e,t,n){var i=Gn(t[1]),s=(i?2:1)+(e<2?0:1),o=t[s],a,l;if(i&&(o.duration=t[1]),o.parent=n,e){for(a=o,l=n;l&&!("immediateRender"in a);)a=l.vars.defaults||{},l=Gt(l.vars.inherit)&&l.parent;o.immediateRender=Gt(a.immediateRender),e<2?o.runBackwards=1:o.startAt=t[s-1]}return new ft(t[0],o,t[s+1])},oi=function(e,t){return e||e===0?t(e):t},ls=function(e,t,n){return n<e?e:n>t?t:n},Rt=function(e,t){return!xt(e)||!(t=p0.exec(e))?"":t[1]},A0=function(e,t,n){return oi(n,function(i){return ls(e,t,i)})},_o=[].slice,Vu=function(e,t){return e&&wn(e)&&"length"in e&&(!t&&!e.length||e.length-1 in e&&wn(e[0]))&&!e.nodeType&&e!==nn},w0=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(i){var s;return xt(i)&&!t||Vu(i,1)?(s=n).push.apply(s,cn(i)):n.push(i)})||n},cn=function(e,t,n){return it&&!t&&it.selector?it.selector(e):xt(e)&&!n&&(ho||!br())?_o.call((t||Fo).querySelectorAll(e),0):Pt(e)?w0(e,n):Vu(e)?_o.call(e,0):e?[e]:[]},go=function(e){return e=cn(e)[0]||Ys("Invalid scope")||{},function(t){var n=e.current||e.nativeElement||e;return cn(t,n.querySelectorAll?n:n===e?Ys("Invalid scope")||Fo.createElement("div"):e)}},Wu=function(e){return e.sort(function(){return .5-Math.random()})},Xu=function(e){if(rt(e))return e;var t=wn(e)?e:{each:e},n=Ci(t.ease),i=t.from||0,s=parseFloat(t.base)||0,o={},a=i>0&&i<1,l=isNaN(i)||a,c=t.axis,u=i,h=i;return xt(i)?u=h={center:.5,edges:.5,end:1}[i]||0:!a&&l&&(u=i[0],h=i[1]),function(f,m,g){var _=(g||t).length,p=o[_],d,E,x,S,y,R,b,D,v;if(!p){if(v=t.grid==="auto"?0:(t.grid||[1,ln])[1],!v){for(b=-ln;b<(b=g[v++].getBoundingClientRect().left)&&v<_;);v--}for(p=o[_]=[],d=l?Math.min(v,_)*u-.5:i%v,E=v===ln?0:l?_*h/v-.5:i/v|0,b=0,D=ln,R=0;R<_;R++)x=R%v-d,S=E-(R/v|0),p[R]=y=c?Math.abs(c==="y"?S:x):Au(x*x+S*S),y>b&&(b=y),y<D&&(D=y);i==="random"&&Wu(p),p.max=b-D,p.min=D,p.v=_=(parseFloat(t.amount)||parseFloat(t.each)*(v>_?_-1:c?c==="y"?_/v:v:Math.max(v,_/v))||0)*(i==="edges"?-1:1),p.b=_<0?s-_:s,p.u=Rt(t.amount||t.each)||0,n=n&&_<0?th(n):n}return _=(p[f]-p.min)/p.max||0,St(p.b+(n?n(_):_)*p.v)+p.u}},vo=function(e){var t=Math.pow(10,((e+"").split(".")[1]||"").length);return function(n){var i=St(Math.round(parseFloat(n)/e)*e*t);return(i-i%1)/t+(Gn(n)?0:Rt(n))}},qu=function(e,t){var n=Pt(e),i,s;return!n&&wn(e)&&(i=n=e.radius||ln,e.values?(e=cn(e.values),(s=!Gn(e[0]))&&(i*=i)):e=vo(e.increment)),oi(t,n?rt(e)?function(o){return s=e(o),Math.abs(s-o)<=i?s:o}:function(o){for(var a=parseFloat(s?o.x:o),l=parseFloat(s?o.y:0),c=ln,u=0,h=e.length,f,m;h--;)s?(f=e[h].x-a,m=e[h].y-l,f=f*f+m*m):f=Math.abs(e[h]-a),f<c&&(c=f,u=h);return u=!i||c<=i?e[u]:o,s||u===o||Gn(o)?u:u+Rt(o)}:vo(e))},Yu=function(e,t,n,i){return oi(Pt(e)?!t:n===!0?!!(n=0):!i,function(){return Pt(e)?e[~~(Math.random()*e.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*i)/i})},R0=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(i){return t.reduce(function(s,o){return o(s)},i)}},C0=function(e,t){return function(n){return e(parseFloat(n))+(t||Rt(n))}},P0=function(e,t,n){return Ku(e,t,0,1,n)},ju=function(e,t,n){return oi(n,function(i){return e[~~t(i)]})},L0=function r(e,t,n){var i=t-e;return Pt(e)?ju(e,r(0,e.length),t):oi(n,function(s){return(i+(s-e)%i)%i+e})},D0=function r(e,t,n){var i=t-e,s=i*2;return Pt(e)?ju(e,r(0,e.length-1),t):oi(n,function(o){return o=(s+(o-e)%s)%s||0,e+(o>i?s-o:o)})},$r=function(e){for(var t=0,n="",i,s,o,a;~(i=e.indexOf("random(",t));)o=e.indexOf(")",i),a=e.charAt(i+7)==="[",s=e.substr(i+7,o-i-7).match(a?Pu:uo),n+=e.substr(t,i-t)+Yu(a?s:+s[0],a?0:+s[1],+s[2]||1e-5),t=o+1;return n+e.substr(t,e.length-t)},Ku=function(e,t,n,i,s){var o=t-e,a=i-n;return oi(s,function(l){return n+((l-e)/o*a||0)})},U0=function r(e,t,n,i){var s=isNaN(e+t)?0:function(m){return(1-m)*e+m*t};if(!s){var o=xt(e),a={},l,c,u,h,f;if(n===!0&&(i=1)&&(n=null),o)e={p:e},t={p:t};else if(Pt(e)&&!Pt(t)){for(u=[],h=e.length,f=h-2,c=1;c<h;c++)u.push(r(e[c-1],e[c]));h--,s=function(g){g*=h;var _=Math.min(f,~~g);return u[_](g-_)},n=t}else i||(e=Ni(Pt(e)?[]:{},e));if(!u){for(l in t)ko.call(a,e,l,"get",t[l]);s=function(g){return qo(g,a)||(o?e.p:e)}}}return oi(n,s)},Ic=function(e,t,n){var i=e.labels,s=ln,o,a,l;for(o in i)a=i[o]-t,a<0==!!n&&a&&s>(a=Math.abs(a))&&(l=o,s=a);return l},un=function(e,t,n){var i=e.vars,s=i[t],o=it,a=e._ctx,l,c,u;if(s)return l=i[t+"Params"],c=i.callbackScope||e,n&&ni.length&&js(),a&&(it=a),u=l?s.apply(c,l):s.call(c),it=o,u},Fr=function(e){return si(e),e.scrollTrigger&&e.scrollTrigger.kill(!!Ct),e.progress()<1&&un(e,"onInterrupt"),e},lr,Zu=[],$u=function(e){if(Oo()&&e){e=!e.name&&e.default||e;var t=e.name,n=rt(e),i=t&&!n&&e.init?function(){this._props=[]}:e,s={init:Zr,render:qo,add:ko,kill:K0,modifier:j0,rawVars:0},o={targetTest:0,get:0,getSetter:Xo,aliases:{},register:0};if(br(),e!==i){if(jt[t])return;hn(i,hn(Ks(e,s),o)),Ni(i.prototype,Ni(s,Ks(e,o))),jt[i.prop=t]=i,e.targetTest&&(Fs.push(i),zo[t]=1),t=(t==="css"?"CSS":t.charAt(0).toUpperCase()+t.substr(1))+"Plugin"}Uu(t,i),e.register&&e.register(Vt,i,kt)}else e&&Zu.push(e)},je=255,Br={aqua:[0,je,je],lime:[0,je,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,je],navy:[0,0,128],white:[je,je,je],olive:[128,128,0],yellow:[je,je,0],orange:[je,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[je,0,0],pink:[je,192,203],cyan:[0,je,je],transparent:[je,je,je,0]},Ya=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*je+.5|0},Ju=function(e,t,n){var i=e?Gn(e)?[e>>16,e>>8&je,e&je]:0:Br.black,s,o,a,l,c,u,h,f,m,g;if(!i){if(e.substr(-1)===","&&(e=e.substr(0,e.length-1)),Br[e])i=Br[e];else if(e.charAt(0)==="#"){if(e.length<6&&(s=e.charAt(1),o=e.charAt(2),a=e.charAt(3),e="#"+s+s+o+o+a+a+(e.length===5?e.charAt(4)+e.charAt(4):"")),e.length===9)return i=parseInt(e.substr(1,6),16),[i>>16,i>>8&je,i&je,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),i=[e>>16,e>>8&je,e&je]}else if(e.substr(0,3)==="hsl"){if(i=g=e.match(uo),!t)l=+i[0]%360/360,c=+i[1]/100,u=+i[2]/100,o=u<=.5?u*(c+1):u+c-u*c,s=u*2-o,i.length>3&&(i[3]*=1),i[0]=Ya(l+1/3,s,o),i[1]=Ya(l,s,o),i[2]=Ya(l-1/3,s,o);else if(~e.indexOf("="))return i=e.match(Ru),n&&i.length<4&&(i[3]=1),i}else i=e.match(uo)||Br.transparent;i=i.map(Number)}return t&&!g&&(s=i[0]/je,o=i[1]/je,a=i[2]/je,h=Math.max(s,o,a),f=Math.min(s,o,a),u=(h+f)/2,h===f?l=c=0:(m=h-f,c=u>.5?m/(2-h-f):m/(h+f),l=h===s?(o-a)/m+(o<a?6:0):h===o?(a-s)/m+2:(s-o)/m+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(u*100+.5)),n&&i.length<4&&(i[3]=1),i},Qu=function(e){var t=[],n=[],i=-1;return e.split(ii).forEach(function(s){var o=s.match(or)||[];t.push.apply(t,o),n.push(i+=o.length+1)}),t.c=n,t},Nc=function(e,t,n){var i="",s=(e+i).match(ii),o=t?"hsla(":"rgba(",a=0,l,c,u,h;if(!s)return e;if(s=s.map(function(f){return(f=Ju(f,t,1))&&o+(t?f[0]+","+f[1]+"%,"+f[2]+"%,"+f[3]:f.join(","))+")"}),n&&(u=Qu(e),l=n.c,l.join(i)!==u.c.join(i)))for(c=e.replace(ii,"1").split(or),h=c.length-1;a<h;a++)i+=c[a]+(~l.indexOf(a)?s.shift()||o+"0,0,0,0)":(u.length?u:s.length?s:n).shift());if(!c)for(c=e.split(ii),h=c.length-1;a<h;a++)i+=c[a]+s[a];return i+c[h]},ii=function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",e;for(e in Br)r+="|"+e+"\\b";return new RegExp(r+")","gi")}(),I0=/hsl[a]?\(/,eh=function(e){var t=e.join(" "),n;if(ii.lastIndex=0,ii.test(t))return n=I0.test(t),e[1]=Nc(e[1],n),e[0]=Nc(e[0],n,Qu(e[1])),!0},Jr,Kt=function(){var r=Date.now,e=500,t=33,n=r(),i=n,s=1e3/240,o=s,a=[],l,c,u,h,f,m,g=function _(p){var d=r()-i,E=p===!0,x,S,y,R;if(d>e&&(n+=d-t),i+=d,y=i-n,x=y-o,(x>0||E)&&(R=++h.frame,f=y-h.time*1e3,h.time=y=y/1e3,o+=x+(x>=s?4:s-x),S=1),E||(l=c(_)),S)for(m=0;m<a.length;m++)a[m](y,f,R,p)};return h={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(p){return f/(1e3/(p||60))},wake:function(){Lu&&(!ho&&Oo()&&(nn=ho=window,Fo=nn.document||{},Jt.gsap=Vt,(nn.gsapVersions||(nn.gsapVersions=[])).push(Vt.version),Du(qs||nn.GreenSockGlobals||!nn.gsap&&nn||{}),u=nn.requestAnimationFrame,Zu.forEach($u)),l&&h.sleep(),c=u||function(p){return setTimeout(p,o-h.time*1e3+1|0)},Jr=1,g(2))},sleep:function(){(u?nn.cancelAnimationFrame:clearTimeout)(l),Jr=0,c=Zr},lagSmoothing:function(p,d){e=p||1/0,t=Math.min(d||33,e)},fps:function(p){s=1e3/(p||240),o=h.time*1e3+s},add:function(p,d,E){var x=d?function(S,y,R,b){p(S,y,R,b),h.remove(x)}:p;return h.remove(p),a[E?"unshift":"push"](x),br(),x},remove:function(p,d){~(d=a.indexOf(p))&&a.splice(d,1)&&m>=d&&m--},_listeners:a},h}(),br=function(){return!Jr&&Kt.wake()},We={},N0=/^[\d.\-M][\d.\-,\s]/,O0=/["']/g,F0=function(e){for(var t={},n=e.substr(1,e.length-3).split(":"),i=n[0],s=1,o=n.length,a,l,c;s<o;s++)l=n[s],a=s!==o-1?l.lastIndexOf(","):l.length,c=l.substr(0,a),t[i]=isNaN(c)?c.replace(O0,"").trim():+c,i=l.substr(a+1).trim();return t},B0=function(e){var t=e.indexOf("(")+1,n=e.indexOf(")"),i=e.indexOf("(",t);return e.substring(t,~i&&i<n?e.indexOf(")",n+1):n)},z0=function(e){var t=(e+"").split("("),n=We[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf("{")?[F0(t[1])]:B0(e).split(",").map(Fu)):We._CE&&N0.test(e)?We._CE("",e):n},th=function(e){return function(t){return 1-e(1-t)}},nh=function r(e,t){for(var n=e._first,i;n;)n instanceof Ft?r(n,t):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==t&&(n.timeline?r(n.timeline,t):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=t)),n=n._next},Ci=function(e,t){return e&&(rt(e)?e:We[e]||z0(e))||t},Bi=function(e,t,n,i){n===void 0&&(n=function(l){return 1-t(1-l)}),i===void 0&&(i=function(l){return l<.5?t(l*2)/2:1-t((1-l)*2)/2});var s={easeIn:t,easeOut:n,easeInOut:i},o;return Ht(e,function(a){We[a]=Jt[a]=s,We[o=a.toLowerCase()]=n;for(var l in s)We[o+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=We[a+"."+l]=s[l]}),s},ih=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},ja=function r(e,t,n){var i=t>=1?t:1,s=(n||(e?.3:.45))/(t<1?t:1),o=s/co*(Math.asin(1/i)||0),a=function(u){return u===1?1:i*Math.pow(2,-10*u)*d0((u-o)*s)+1},l=e==="out"?a:e==="in"?function(c){return 1-a(1-c)}:ih(a);return s=co/s,l.config=function(c,u){return r(e,c,u)},l},Ka=function r(e,t){t===void 0&&(t=1.70158);var n=function(o){return o?--o*o*((t+1)*o+t)+1:0},i=e==="out"?n:e==="in"?function(s){return 1-n(1-s)}:ih(n);return i.config=function(s){return r(e,s)},i};Ht("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,e){var t=e<5?e+1:e;Bi(r+",Power"+(t-1),e?function(n){return Math.pow(n,t)}:function(n){return n},function(n){return 1-Math.pow(1-n,t)},function(n){return n<.5?Math.pow(n*2,t)/2:1-Math.pow((1-n)*2,t)/2})});We.Linear.easeNone=We.none=We.Linear.easeIn;Bi("Elastic",ja("in"),ja("out"),ja());(function(r,e){var t=1/e,n=2*t,i=2.5*t,s=function(a){return a<t?r*a*a:a<n?r*Math.pow(a-1.5/e,2)+.75:a<i?r*(a-=2.25/e)*a+.9375:r*Math.pow(a-2.625/e,2)+.984375};Bi("Bounce",function(o){return 1-s(1-o)},s)})(7.5625,2.75);Bi("Expo",function(r){return r?Math.pow(2,10*(r-1)):0});Bi("Circ",function(r){return-(Au(1-r*r)-1)});Bi("Sine",function(r){return r===1?1:-f0(r*u0)+1});Bi("Back",Ka("in"),Ka("out"),Ka());We.SteppedEase=We.steps=Jt.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,i=e+(t?0:1),s=t?1:0,o=1-Ke;return function(a){return((i*ls(0,o,a)|0)+s)*n}}};Er.ease=We["quad.out"];Ht("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return Go+=r+","+r+"Params,"});var rh=function(e,t){this.id=h0++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:Nu,this.set=t?t.getSetter:Xo},Qr=function(){function r(t){this.vars=t,this._delay=+t.delay||0,(this._repeat=t.repeat===1/0?-2:t.repeat||0)&&(this._rDelay=t.repeatDelay||0,this._yoyo=!!t.yoyo||!!t.yoyoEase),this._ts=1,Tr(this,+t.duration,1,1),this.data=t.data,it&&(this._ctx=it,it.data.push(this)),Jr||Kt.wake()}var e=r.prototype;return e.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},e.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},e.totalDuration=function(n){return arguments.length?(this._dirty=0,Tr(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},e.totalTime=function(n,i){if(br(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(ua(this,n),!s._dp||s.parent||Gu(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&yn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===Ke||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),Ou(this,n,i)),this},e.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+Dc(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},e.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.ratio},e.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+Dc(this),i):this.duration()?Math.min(1,this._time/this._dur):this.ratio},e.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?yr(this._tTime,s)+1:1},e.timeScale=function(n){if(!arguments.length)return this._rts===-Ke?0:this._rts;if(this._rts===n)return this;var i=this.parent&&this._ts?Zs(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-Ke?0:this._rts,this.totalTime(ls(-Math.abs(this._delay),this._tDur,i),!0),ca(this),M0(this)},e.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(br(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==Ke&&(this._tTime-=Ke)))),this):this._ps},e.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&yn(i,this,n-this._delay),this}return this._start},e.endTime=function(n){return this._start+(Gt(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},e.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Zs(i.rawTime(n),this):this._tTime:this._tTime},e.revert=function(n){n===void 0&&(n=_0);var i=Ct;return Ct=n,(this._initted||this._startAt)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Ct=i,this},e.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(i._ts||1),i=i._dp;return!this.parent&&this._sat?this._sat.vars.immediateRender?-1/0:this._sat.globalTime(n):s},e.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Uc(this)):this._repeat===-2?1/0:this._repeat},e.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,Uc(this),i?this.time(i):this}return this._rDelay},e.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},e.seek=function(n,i){return this.totalTime(tn(this,n),Gt(i))},e.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,Gt(i))},e.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},e.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},e.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},e.resume=function(){return this.paused(!1)},e.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-Ke:0)),this):this._rts<0},e.invalidate=function(){return this._initted=this._act=0,this._zTime=-Ke,this},e.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-Ke)},e.eventCallback=function(n,i,s){var o=this.vars;return arguments.length>1?(i?(o[n]=i,s&&(o[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete o[n],this):o[n]},e.then=function(n){var i=this;return new Promise(function(s){var o=rt(n)?n:Bu,a=function(){var c=i.then;i.then=null,rt(o)&&(o=o(i))&&(o.then||o===i)&&(i.then=c),s(o),i.then=c};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?a():i._prom=a})},e.kill=function(){Fr(this)},r}();hn(Qr.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-Ke,_prom:0,_ps:!1,_rts:1});var Ft=function(r){bu(e,r);function e(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=Gt(n.sortChildren),et&&yn(n.parent||et,Nn(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&Hu(Nn(s),n.scrollTrigger),s}var t=e.prototype;return t.to=function(i,s,o){return Vr(0,arguments,this),this},t.from=function(i,s,o){return Vr(1,arguments,this),this},t.fromTo=function(i,s,o,a){return Vr(2,arguments,this),this},t.set=function(i,s,o){return s.duration=0,s.parent=this,kr(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new ft(i,s,tn(this,o),1),this},t.call=function(i,s,o){return yn(this,ft.delayedCall(0,i,s),o)},t.staggerTo=function(i,s,o,a,l,c,u){return o.duration=s,o.stagger=o.stagger||a,o.onComplete=c,o.onCompleteParams=u,o.parent=this,new ft(i,o,tn(this,l)),this},t.staggerFrom=function(i,s,o,a,l,c,u){return o.runBackwards=1,kr(o).immediateRender=Gt(o.immediateRender),this.staggerTo(i,s,o,a,l,c,u)},t.staggerFromTo=function(i,s,o,a,l,c,u,h){return a.startAt=o,kr(a).immediateRender=Gt(a.immediateRender),this.staggerTo(i,s,a,l,c,u,h)},t.render=function(i,s,o){var a=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=i<=0?0:St(i),h=this._zTime<0!=i<0&&(this._initted||!c),f,m,g,_,p,d,E,x,S,y,R,b;if(this!==et&&u>l&&i>=0&&(u=l),u!==this._tTime||o||h){if(a!==this._time&&c&&(u+=this._time-a,i+=this._time-a),f=u,S=this._start,x=this._ts,d=!x,h&&(c||(a=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(R=this._yoyo,p=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(p*100+i,s,o);if(f=St(u%p),u===l?(_=this._repeat,f=c):(_=~~(u/p),_&&_===u/p&&(f=c,_--),f>c&&(f=c)),y=yr(this._tTime,p),!a&&this._tTime&&y!==_&&this._tTime-y*p-this._dur<=0&&(y=_),R&&_&1&&(f=c-f,b=1),_!==y&&!this._lock){var D=R&&y&1,v=D===(R&&_&1);if(_<y&&(D=!D),a=D?0:u%c?c:u,this._lock=1,this.render(a||(b?0:St(_*p)),s,!c)._lock=0,this._tTime=u,!s&&this.parent&&un(this,"onRepeat"),this.vars.repeatRefresh&&!b&&(this.invalidate()._lock=1),a&&a!==this._time||d!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,v&&(this._lock=2,a=D?c:-1e-4,this.render(a,!0),this.vars.repeatRefresh&&!b&&this.invalidate()),this._lock=0,!this._ts&&!d)return this;nh(this,b)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(E=T0(this,St(a),St(f)),E&&(u-=f-(f=E._start))),this._tTime=u,this._time=f,this._act=!x,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,a=0),!a&&f&&!s&&!_&&(un(this,"onStart"),this._tTime!==u))return this;if(f>=a&&i>=0)for(m=this._first;m;){if(g=m._next,(m._act||f>=m._start)&&m._ts&&E!==m){if(m.parent!==this)return this.render(i,s,o);if(m.render(m._ts>0?(f-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(f-m._start)*m._ts,s,o),f!==this._time||!this._ts&&!d){E=0,g&&(u+=this._zTime=-Ke);break}}m=g}else{m=this._last;for(var A=i<0?i:f;m;){if(g=m._prev,(m._act||A<=m._end)&&m._ts&&E!==m){if(m.parent!==this)return this.render(i,s,o);if(m.render(m._ts>0?(A-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(A-m._start)*m._ts,s,o||Ct&&(m._initted||m._startAt)),f!==this._time||!this._ts&&!d){E=0,g&&(u+=this._zTime=A?-Ke:Ke);break}}m=g}}if(E&&!s&&(this.pause(),E.render(f>=a?0:-Ke)._zTime=f>=a?1:-1,this._ts))return this._start=S,ca(this),this.render(i,s,o);this._onUpdate&&!s&&un(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&a)&&(S===this._start||Math.abs(x)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&si(this,1),!s&&!(i<0&&!a)&&(u||a||!l)&&(un(this,u===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},t.add=function(i,s){var o=this;if(Gn(s)||(s=tn(this,s,i)),!(i instanceof Qr)){if(Pt(i))return i.forEach(function(a){return o.add(a,s)}),this;if(xt(i))return this.addLabel(i,s);if(rt(i))i=ft.delayedCall(0,i);else return this}return this!==i?yn(this,i,s):this},t.getChildren=function(i,s,o,a){i===void 0&&(i=!0),s===void 0&&(s=!0),o===void 0&&(o=!0),a===void 0&&(a=-ln);for(var l=[],c=this._first;c;)c._start>=a&&(c instanceof ft?s&&l.push(c):(o&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,s,o)))),c=c._next;return l},t.getById=function(i){for(var s=this.getChildren(1,1,1),o=s.length;o--;)if(s[o].vars.id===i)return s[o]},t.remove=function(i){return xt(i)?this.removeLabel(i):rt(i)?this.killTweensOf(i):(la(this,i),i===this._recent&&(this._recent=this._last),Ri(this))},t.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=St(Kt.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},t.addLabel=function(i,s){return this.labels[i]=tn(this,s),this},t.removeLabel=function(i){return delete this.labels[i],this},t.addPause=function(i,s,o){var a=ft.delayedCall(0,s||Zr,o);return a.data="isPause",this._hasPause=1,yn(this,a,tn(this,i))},t.removePause=function(i){var s=this._first;for(i=tn(this,i);s;)s._start===i&&s.data==="isPause"&&si(s),s=s._next},t.killTweensOf=function(i,s,o){for(var a=this.getTweensOf(i,o),l=a.length;l--;)Zn!==a[l]&&a[l].kill(i,s);return this},t.getTweensOf=function(i,s){for(var o=[],a=cn(i),l=this._first,c=Gn(s),u;l;)l instanceof ft?g0(l._targets,a)&&(c?(!Zn||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&o.push(l):(u=l.getTweensOf(a,s)).length&&o.push.apply(o,u),l=l._next;return o},t.tweenTo=function(i,s){s=s||{};var o=this,a=tn(o,i),l=s,c=l.startAt,u=l.onStart,h=l.onStartParams,f=l.immediateRender,m,g=ft.to(o,hn({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:a,overwrite:"auto",duration:s.duration||Math.abs((a-(c&&"time"in c?c.time:o._time))/o.timeScale())||Ke,onStart:function(){if(o.pause(),!m){var p=s.duration||Math.abs((a-(c&&"time"in c?c.time:o._time))/o.timeScale());g._dur!==p&&Tr(g,p,0,1).render(g._time,!0,!0),m=1}u&&u.apply(g,h||[])}},s));return f?g.render(0):g},t.tweenFromTo=function(i,s,o){return this.tweenTo(s,hn({startAt:{time:tn(this,i)}},o))},t.recent=function(){return this._recent},t.nextLabel=function(i){return i===void 0&&(i=this._time),Ic(this,tn(this,i))},t.previousLabel=function(i){return i===void 0&&(i=this._time),Ic(this,tn(this,i),1)},t.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+Ke)},t.shiftChildren=function(i,s,o){o===void 0&&(o=0);for(var a=this._first,l=this.labels,c;a;)a._start>=o&&(a._start+=i,a._end+=i),a=a._next;if(s)for(c in l)l[c]>=o&&(l[c]+=i);return Ri(this)},t.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},t.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,o;s;)o=s._next,this.remove(s),s=o;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),Ri(this)},t.totalDuration=function(i){var s=0,o=this,a=o._last,l=ln,c,u,h;if(arguments.length)return o.timeScale((o._repeat<0?o.duration():o.totalDuration())/(o.reversed()?-i:i));if(o._dirty){for(h=o.parent;a;)c=a._prev,a._dirty&&a.totalDuration(),u=a._start,u>l&&o._sort&&a._ts&&!o._lock?(o._lock=1,yn(o,a,u-a._delay,1)._lock=0):l=u,u<0&&a._ts&&(s-=u,(!h&&!o._dp||h&&h.smoothChildTiming)&&(o._start+=u/o._ts,o._time-=u,o._tTime-=u),o.shiftChildren(-u,!1,-1/0),l=0),a._end>s&&a._ts&&(s=a._end),a=c;Tr(o,o===et&&o._time>s?o._time:s,1,1),o._dirty=0}return o._tDur},e.updateRoot=function(i){if(et._ts&&(Ou(et,Zs(i,et)),Iu=Kt.frame),Kt.frame>=Pc){Pc+=$t.autoSleep||120;var s=et._first;if((!s||!s._ts)&&$t.autoSleep&&Kt._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||Kt.sleep()}}},e}(Qr);hn(Ft.prototype,{_lock:0,_hasPause:0,_forcing:0});var G0=function(e,t,n,i,s,o,a){var l=new kt(this._pt,e,t,0,1,uh,null,s),c=0,u=0,h,f,m,g,_,p,d,E;for(l.b=n,l.e=i,n+="",i+="",(d=~i.indexOf("random("))&&(i=$r(i)),o&&(E=[n,i],o(E,e,t),n=E[0],i=E[1]),f=n.match(Xa)||[];h=Xa.exec(i);)g=h[0],_=i.substring(c,h.index),m?m=(m+1)%5:_.substr(-5)==="rgba("&&(m=1),g!==f[u++]&&(p=parseFloat(f[u-1])||0,l._pt={_next:l._pt,p:_||u===1?_:",",s:p,c:g.charAt(1)==="="?mr(p,g)-p:parseFloat(g)-p,m:m&&m<4?Math.round:0},c=Xa.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=a,(Cu.test(i)||d)&&(l.e=0),this._pt=l,l},ko=function(e,t,n,i,s,o,a,l,c,u){rt(i)&&(i=i(s||0,e,o));var h=e[t],f=n!=="get"?n:rt(h)?c?e[t.indexOf("set")||!rt(e["get"+t.substr(3)])?t:"get"+t.substr(3)](c):e[t]():h,m=rt(h)?c?X0:lh:Wo,g;if(xt(i)&&(~i.indexOf("random(")&&(i=$r(i)),i.charAt(1)==="="&&(g=mr(f,i)+(Rt(f)||0),(g||g===0)&&(i=g))),!u||f!==i||xo)return!isNaN(f*i)&&i!==""?(g=new kt(this._pt,e,t,+f||0,i-(f||0),typeof h=="boolean"?Y0:ch,0,m),c&&(g.fp=c),a&&g.modifier(a,this,e),this._pt=g):(!h&&!(t in e)&&Bo(t,i),G0.call(this,e,t,f,i,m,l||$t.stringFilter,c))},H0=function(e,t,n,i,s){if(rt(e)&&(e=Wr(e,s,t,n,i)),!wn(e)||e.style&&e.nodeType||Pt(e)||wu(e))return xt(e)?Wr(e,s,t,n,i):e;var o={},a;for(a in e)o[a]=Wr(e[a],s,t,n,i);return o},sh=function(e,t,n,i,s,o){var a,l,c,u;if(jt[e]&&(a=new jt[e]).init(s,a.rawVars?t[e]:H0(t[e],i,s,o,n),n,i,o)!==!1&&(n._pt=l=new kt(n._pt,s,e,0,1,a.render,a,0,a.priority),n!==lr))for(c=n._ptLookup[n._targets.indexOf(s)],u=a._props.length;u--;)c[a._props[u]]=l;return a},Zn,xo,Vo=function r(e,t,n){var i=e.vars,s=i.ease,o=i.startAt,a=i.immediateRender,l=i.lazy,c=i.onUpdate,u=i.onUpdateParams,h=i.callbackScope,f=i.runBackwards,m=i.yoyoEase,g=i.keyframes,_=i.autoRevert,p=e._dur,d=e._startAt,E=e._targets,x=e.parent,S=x&&x.data==="nested"?x.vars.targets:E,y=e._overwrite==="auto"&&!Io,R=e.timeline,b,D,v,A,z,q,j,P,O,X,k,J,$;if(R&&(!g||!s)&&(s="none"),e._ease=Ci(s,Er.ease),e._yEase=m?th(Ci(m===!0?s:m,Er.ease)):0,m&&e._yoyo&&!e._repeat&&(m=e._yEase,e._yEase=e._ease,e._ease=m),e._from=!R&&!!i.runBackwards,!R||g&&!i.stagger){if(P=E[0]?wi(E[0]).harness:0,J=P&&i[P.prop],b=Ks(i,zo),d&&(d._zTime<0&&d.progress(1),t<0&&f&&a&&!_?d.render(-1,!0):d.revert(f&&p?Os:m0),d._lazy=0),o){if(si(e._startAt=ft.set(E,hn({data:"isStart",overwrite:!1,parent:x,immediateRender:!0,lazy:!d&&Gt(l),startAt:null,delay:0,onUpdate:c,onUpdateParams:u,callbackScope:h,stagger:0},o))),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Ct||!a&&!_)&&e._startAt.revert(Os),a&&p&&t<=0&&n<=0){t&&(e._zTime=t);return}}else if(f&&p&&!d){if(t&&(a=!1),v=hn({overwrite:!1,data:"isFromStart",lazy:a&&!d&&Gt(l),immediateRender:a,stagger:0,parent:x},b),J&&(v[P.prop]=J),si(e._startAt=ft.set(E,v)),e._startAt._dp=0,e._startAt._sat=e,t<0&&(Ct?e._startAt.revert(Os):e._startAt.render(-1,!0)),e._zTime=t,!a)r(e._startAt,Ke,Ke);else if(!t)return}for(e._pt=e._ptCache=0,l=p&&Gt(l)||l&&!p,D=0;D<E.length;D++){if(z=E[D],j=z._gsap||Ho(E)[D]._gsap,e._ptLookup[D]=X={},fo[j.id]&&ni.length&&js(),k=S===E?D:S.indexOf(z),P&&(O=new P).init(z,J||b,e,k,S)!==!1&&(e._pt=A=new kt(e._pt,z,O.name,0,1,O.render,O,0,O.priority),O._props.forEach(function(K){X[K]=A}),O.priority&&(q=1)),!P||J)for(v in b)jt[v]&&(O=sh(v,b,e,k,z,S))?O.priority&&(q=1):X[v]=A=ko.call(e,z,v,"get",b[v],k,S,0,i.stringFilter);e._op&&e._op[D]&&e.kill(z,e._op[D]),y&&e._pt&&(Zn=e,et.killTweensOf(z,X,e.globalTime(t)),$=!e.parent,Zn=0),e._pt&&l&&(fo[j.id]=1)}q&&hh(e),e._onInit&&e._onInit(e)}e._onUpdate=c,e._initted=(!e._op||e._pt)&&!$,g&&t<=0&&R.render(ln,!0,!0)},k0=function(e,t,n,i,s,o,a){var l=(e._pt&&e._ptCache||(e._ptCache={}))[t],c,u,h,f;if(!l)for(l=e._ptCache[t]=[],h=e._ptLookup,f=e._targets.length;f--;){if(c=h[f][t],c&&c.d&&c.d._pt)for(c=c.d._pt;c&&c.p!==t&&c.fp!==t;)c=c._next;if(!c)return xo=1,e.vars[t]="+=0",Vo(e,a),xo=0,1;l.push(c)}for(f=l.length;f--;)u=l[f],c=u._pt||u,c.s=(i||i===0)&&!s?i:c.s+(i||0)+o*c.c,c.c=n-c.s,u.e&&(u.e=ot(n)+Rt(u.e)),u.b&&(u.b=c.s+Rt(u.b))},V0=function(e,t){var n=e[0]?wi(e[0]).harness:0,i=n&&n.aliases,s,o,a,l;if(!i)return t;s=Ni({},t);for(o in i)if(o in s)for(l=i[o].split(","),a=l.length;a--;)s[l[a]]=s[o];return s},W0=function(e,t,n,i){var s=t.ease||i||"power1.inOut",o,a;if(Pt(t))a=n[e]||(n[e]=[]),t.forEach(function(l,c){return a.push({t:c/(t.length-1)*100,v:l,e:s})});else for(o in t)a=n[o]||(n[o]=[]),o==="ease"||a.push({t:parseFloat(e),v:t[o],e:s})},Wr=function(e,t,n,i,s){return rt(e)?e.call(t,n,i,s):xt(e)&&~e.indexOf("random(")?$r(e):e},ah=Go+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",oh={};Ht(ah+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return oh[r]=1});var ft=function(r){bu(e,r);function e(n,i,s,o){var a;typeof i=="number"&&(s.duration=i,i=s,s=null),a=r.call(this,o?i:kr(i))||this;var l=a.vars,c=l.duration,u=l.delay,h=l.immediateRender,f=l.stagger,m=l.overwrite,g=l.keyframes,_=l.defaults,p=l.scrollTrigger,d=l.yoyoEase,E=i.parent||et,x=(Pt(n)||wu(n)?Gn(n[0]):"length"in i)?[n]:cn(n),S,y,R,b,D,v,A,z;if(a._targets=x.length?Ho(x):Ys("GSAP target "+n+" not found. https://greensock.com",!$t.nullTargetWarn)||[],a._ptLookup=[],a._overwrite=m,g||f||Is(c)||Is(u)){if(i=a.vars,S=a.timeline=new Ft({data:"nested",defaults:_||{},targets:E&&E.data==="nested"?E.vars.targets:x}),S.kill(),S.parent=S._dp=Nn(a),S._start=0,f||Is(c)||Is(u)){if(b=x.length,A=f&&Xu(f),wn(f))for(D in f)~ah.indexOf(D)&&(z||(z={}),z[D]=f[D]);for(y=0;y<b;y++)R=Ks(i,oh),R.stagger=0,d&&(R.yoyoEase=d),z&&Ni(R,z),v=x[y],R.duration=+Wr(c,Nn(a),y,v,x),R.delay=(+Wr(u,Nn(a),y,v,x)||0)-a._delay,!f&&b===1&&R.delay&&(a._delay=u=R.delay,a._start+=u,R.delay=0),S.to(v,R,A?A(y,v,x):0),S._ease=We.none;S.duration()?c=u=0:a.timeline=0}else if(g){kr(hn(S.vars.defaults,{ease:"none"})),S._ease=Ci(g.ease||i.ease||"none");var q=0,j,P,O;if(Pt(g))g.forEach(function(X){return S.to(x,X,">")}),S.duration();else{R={};for(D in g)D==="ease"||D==="easeEach"||W0(D,g[D],R,g.easeEach);for(D in R)for(j=R[D].sort(function(X,k){return X.t-k.t}),q=0,y=0;y<j.length;y++)P=j[y],O={ease:P.e,duration:(P.t-(y?j[y-1].t:0))/100*c},O[D]=P.v,S.to(x,O,q),q+=O.duration;S.duration()<c&&S.to({},{duration:c-S.duration()})}}c||a.duration(c=S.duration())}else a.timeline=0;return m===!0&&!Io&&(Zn=Nn(a),et.killTweensOf(x),Zn=0),yn(E,Nn(a),s),i.reversed&&a.reverse(),i.paused&&a.paused(!0),(h||!c&&!g&&a._start===St(E._time)&&Gt(h)&&S0(Nn(a))&&E.data!=="nested")&&(a._tTime=-Ke,a.render(Math.max(0,-u)||0)),p&&Hu(Nn(a),p),a}var t=e.prototype;return t.render=function(i,s,o){var a=this._time,l=this._tDur,c=this._dur,u=i<0,h=i>l-Ke&&!u?l:i<Ke?0:i,f,m,g,_,p,d,E,x,S;if(!c)y0(this,i,s,o);else if(h!==this._tTime||!i||o||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u){if(f=h,x=this.timeline,this._repeat){if(_=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(_*100+i,s,o);if(f=St(h%_),h===l?(g=this._repeat,f=c):(g=~~(h/_),g&&g===h/_&&(f=c,g--),f>c&&(f=c)),d=this._yoyo&&g&1,d&&(S=this._yEase,f=c-f),p=yr(this._tTime,_),f===a&&!o&&this._initted)return this._tTime=h,this;g!==p&&(x&&this._yEase&&nh(x,d),this.vars.repeatRefresh&&!d&&!this._lock&&(this._lock=o=1,this.render(St(_*g),!0).invalidate()._lock=0))}if(!this._initted){if(ku(this,u?i:f,o,s,h))return this._tTime=0,this;if(a!==this._time)return this;if(c!==this._dur)return this.render(i,s,o)}if(this._tTime=h,this._time=f,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=E=(S||this._ease)(f/c),this._from&&(this.ratio=E=1-E),f&&!a&&!s&&!g&&(un(this,"onStart"),this._tTime!==h))return this;for(m=this._pt;m;)m.r(E,m.d),m=m._next;x&&x.render(i<0?i:!f&&d?-Ke:x._dur*x._ease(f/this._dur),s,o)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(u&&po(this,i,s,o),un(this,"onUpdate")),this._repeat&&g!==p&&this.vars.onRepeat&&!s&&this.parent&&un(this,"onRepeat"),(h===this._tDur||!h)&&this._tTime===h&&(u&&!this._onUpdate&&po(this,i,!0,!0),(i||!c)&&(h===this._tDur&&this._ts>0||!h&&this._ts<0)&&si(this,1),!s&&!(u&&!a)&&(h||a||d)&&(un(this,h===l?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom()))}return this},t.targets=function(){return this._targets},t.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},t.resetTo=function(i,s,o,a){Jr||Kt.wake(),this._ts||this.play();var l=Math.min(this._dur,(this._dp._time-this._start)*this._ts),c;return this._initted||Vo(this,l),c=this._ease(l/this._dur),k0(this,i,s,o,a,c,l)?this.resetTo(i,s,o,a):(ua(this,0),this.parent||zu(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},t.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?Fr(this):this;if(this.timeline){var o=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,Zn&&Zn.vars.overwrite!==!0)._first||Fr(this),this.parent&&o!==this.timeline.totalDuration()&&Tr(this,this._dur*this.timeline._tDur/o,0,1),this}var a=this._targets,l=i?cn(i):a,c=this._ptLookup,u=this._pt,h,f,m,g,_,p,d;if((!s||s==="all")&&x0(a,l))return s==="all"&&(this._pt=0),Fr(this);for(h=this._op=this._op||[],s!=="all"&&(xt(s)&&(_={},Ht(s,function(E){return _[E]=1}),s=_),s=V0(a,s)),d=a.length;d--;)if(~l.indexOf(a[d])){f=c[d],s==="all"?(h[d]=s,g=f,m={}):(m=h[d]=h[d]||{},g=s);for(_ in g)p=f&&f[_],p&&((!("kill"in p.d)||p.d.kill(_)===!0)&&la(this,p,"_pt"),delete f[_]),m!=="all"&&(m[_]=1)}return this._initted&&!this._pt&&u&&Fr(this),this},e.to=function(i,s){return new e(i,s,arguments[2])},e.from=function(i,s){return Vr(1,arguments)},e.delayedCall=function(i,s,o,a){return new e(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:o,onReverseCompleteParams:o,callbackScope:a})},e.fromTo=function(i,s,o){return Vr(2,arguments)},e.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new e(i,s)},e.killTweensOf=function(i,s,o){return et.killTweensOf(i,s,o)},e}(Qr);hn(ft.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});Ht("staggerTo,staggerFrom,staggerFromTo",function(r){ft[r]=function(){var e=new Ft,t=_o.call(arguments,0);return t.splice(r==="staggerFromTo"?5:4,0,0),e[r].apply(e,t)}});var Wo=function(e,t,n){return e[t]=n},lh=function(e,t,n){return e[t](n)},X0=function(e,t,n,i){return e[t](i.fp,n)},q0=function(e,t,n){return e.setAttribute(t,n)},Xo=function(e,t){return rt(e[t])?lh:No(e[t])&&e.setAttribute?q0:Wo},ch=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},Y0=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},uh=function(e,t){var n=t._pt,i="";if(!e&&t.b)i=t.b;else if(e===1&&t.e)i=t.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+i,n=n._next;i+=t.c}t.set(t.t,t.p,i,t)},qo=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},j0=function(e,t,n,i){for(var s=this._pt,o;s;)o=s._next,s.p===i&&s.modifier(e,t,n),s=o},K0=function(e){for(var t=this._pt,n,i;t;)i=t._next,t.p===e&&!t.op||t.op===e?la(this,t,"_pt"):t.dep||(n=1),t=i;return!n},Z0=function(e,t,n,i){i.mSet(e,t,i.m.call(i.tween,n,i.mt),i)},hh=function(e){for(var t=e._pt,n,i,s,o;t;){for(n=t._next,i=s;i&&i.pr>t.pr;)i=i._next;(t._prev=i?i._prev:o)?t._prev._next=t:s=t,(t._next=i)?i._prev=t:o=t,t=n}e._pt=s},kt=function(){function r(t,n,i,s,o,a,l,c,u){this.t=n,this.s=s,this.c=o,this.p=i,this.r=a||ch,this.d=l||this,this.set=c||Wo,this.pr=u||0,this._next=t,t&&(t._prev=this)}var e=r.prototype;return e.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=Z0,this.m=n,this.mt=s,this.tween=i},r}();Ht(Go+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return zo[r]=1});Jt.TweenMax=Jt.TweenLite=ft;Jt.TimelineLite=Jt.TimelineMax=Ft;et=new Ft({sortChildren:!1,defaults:Er,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});$t.stringFilter=eh;var Pi=[],Bs={},$0=[],Oc=0,J0=0,Za=function(e){return(Bs[e]||$0).map(function(t){return t()})},Mo=function(){var e=Date.now(),t=[];e-Oc>2&&(Za("matchMediaInit"),Pi.forEach(function(n){var i=n.queries,s=n.conditions,o,a,l,c;for(a in i)o=nn.matchMedia(i[a]).matches,o&&(l=1),o!==s[a]&&(s[a]=o,c=1);c&&(n.revert(),l&&t.push(n))}),Za("matchMediaRevert"),t.forEach(function(n){return n.onMatch(n)}),Oc=e,Za("matchMedia"))},fh=function(){function r(t,n){this.selector=n&&go(n),this.data=[],this._r=[],this.isReverted=!1,this.id=J0++,t&&this.add(t)}var e=r.prototype;return e.add=function(n,i,s){rt(n)&&(s=i,i=n,n=rt);var o=this,a=function(){var c=it,u=o.selector,h;return c&&c!==o&&c.data.push(o),s&&(o.selector=go(s)),it=o,h=i.apply(o,arguments),rt(h)&&o._r.push(h),it=c,o.selector=u,o.isReverted=!1,h};return o.last=a,n===rt?a(o):n?o[n]=a:a},e.ignore=function(n){var i=it;it=null,n(this),it=i},e.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof ft&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},e.clear=function(){this._r.length=this.data.length=0},e.kill=function(n,i){var s=this;if(n){var o=this.getTweens();this.data.forEach(function(l){l.data==="isFlip"&&(l.revert(),l.getChildren(!0,!0,!1).forEach(function(c){return o.splice(o.indexOf(c),1)}))}),o.map(function(l){return{g:l.globalTime(0),t:l}}).sort(function(l,c){return c.g-l.g||-1/0}).forEach(function(l){return l.t.revert(n)}),this.data.forEach(function(l){return!(l instanceof ft)&&l.revert&&l.revert(n)}),this._r.forEach(function(l){return l(n,s)}),this.isReverted=!0}else this.data.forEach(function(l){return l.kill&&l.kill()});if(this.clear(),i)for(var a=Pi.length;a--;)Pi[a].id===this.id&&Pi.splice(a,1)},e.revert=function(n){this.kill(n||{})},r}(),Q0=function(){function r(t){this.contexts=[],this.scope=t}var e=r.prototype;return e.add=function(n,i,s){wn(n)||(n={matches:n});var o=new fh(0,s||this.scope),a=o.conditions={},l,c,u;it&&!o.selector&&(o.selector=it.selector),this.contexts.push(o),i=o.add("onMatch",i),o.queries=n;for(c in n)c==="all"?u=1:(l=nn.matchMedia(n[c]),l&&(Pi.indexOf(o)<0&&Pi.push(o),(a[c]=l.matches)&&(u=1),l.addListener?l.addListener(Mo):l.addEventListener("change",Mo)));return u&&i(o),this},e.revert=function(n){this.kill(n||{})},e.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r}(),$s={registerPlugin:function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];t.forEach(function(i){return $u(i)})},timeline:function(e){return new Ft(e)},getTweensOf:function(e,t){return et.getTweensOf(e,t)},getProperty:function(e,t,n,i){xt(e)&&(e=cn(e)[0]);var s=wi(e||{}).get,o=n?Bu:Fu;return n==="native"&&(n=""),e&&(t?o((jt[t]&&jt[t].get||s)(e,t,n,i)):function(a,l,c){return o((jt[a]&&jt[a].get||s)(e,a,l,c))})},quickSetter:function(e,t,n){if(e=cn(e),e.length>1){var i=e.map(function(u){return Vt.quickSetter(u,t,n)}),s=i.length;return function(u){for(var h=s;h--;)i[h](u)}}e=e[0]||{};var o=jt[t],a=wi(e),l=a.harness&&(a.harness.aliases||{})[t]||t,c=o?function(u){var h=new o;lr._pt=0,h.init(e,n?u+n:u,lr,0,[e]),h.render(1,h),lr._pt&&qo(1,lr)}:a.set(e,l);return o?c:function(u){return c(e,l,n?u+n:u,a,1)}},quickTo:function(e,t,n){var i,s=Vt.to(e,Ni((i={},i[t]="+=0.1",i.paused=!0,i),n||{})),o=function(l,c,u){return s.resetTo(t,l,c,u)};return o.tween=s,o},isTweening:function(e){return et.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=Ci(e.ease,Er.ease)),Lc(Er,e||{})},config:function(e){return Lc($t,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,i=e.plugins,s=e.defaults,o=e.extendTimeline;(i||"").split(",").forEach(function(a){return a&&!jt[a]&&!Jt[a]&&Ys(t+" effect requires "+a+" plugin.")}),qa[t]=function(a,l,c){return n(cn(a),hn(l||{},s),c)},o&&(Ft.prototype[t]=function(a,l,c){return this.add(qa[t](a,wn(l)?l:(c=l)&&{},this),c)})},registerEase:function(e,t){We[e]=Ci(t)},parseEase:function(e,t){return arguments.length?Ci(e,t):We},getById:function(e){return et.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new Ft(e),i,s;for(n.smoothChildTiming=Gt(e.smoothChildTiming),et.remove(n),n._dp=0,n._time=n._tTime=et._time,i=et._first;i;)s=i._next,(t||!(!i._dur&&i instanceof ft&&i.vars.onComplete===i._targets[0]))&&yn(n,i,i._start-i._delay),i=s;return yn(et,n,0),n},context:function(e,t){return e?new fh(e,t):it},matchMedia:function(e){return new Q0(e)},matchMediaRefresh:function(){return Pi.forEach(function(e){var t=e.conditions,n,i;for(i in t)t[i]&&(t[i]=!1,n=1);n&&e.revert()})||Mo()},addEventListener:function(e,t){var n=Bs[e]||(Bs[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=Bs[e],i=n&&n.indexOf(t);i>=0&&n.splice(i,1)},utils:{wrap:L0,wrapYoyo:D0,distribute:Xu,random:Yu,snap:qu,normalize:P0,getUnit:Rt,clamp:A0,splitColor:Ju,toArray:cn,selector:go,mapRange:Ku,pipe:R0,unitize:C0,interpolate:U0,shuffle:Wu},install:Du,effects:qa,ticker:Kt,updateRoot:Ft.updateRoot,plugins:jt,globalTimeline:et,core:{PropTween:kt,globals:Uu,Tween:ft,Timeline:Ft,Animation:Qr,getCache:wi,_removeLinkedListItem:la,reverting:function(){return Ct},context:function(e){return e&&it&&(it.data.push(e),e._ctx=it),it},suppressOverwrites:function(e){return Io=e}}};Ht("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return $s[r]=ft[r]});Kt.add(Ft.updateRoot);lr=$s.to({},{duration:0});var ev=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},tv=function(e,t){var n=e._targets,i,s,o;for(i in t)for(s=n.length;s--;)o=e._ptLookup[s][i],o&&(o=o.d)&&(o._pt&&(o=ev(o,i)),o&&o.modifier&&o.modifier(t[i],e,n[s],i))},$a=function(e,t){return{name:e,rawVars:1,init:function(i,s,o){o._onInit=function(a){var l,c;if(xt(s)&&(l={},Ht(s,function(u){return l[u]=1}),s=l),t){l={};for(c in s)l[c]=t(s[c]);s=l}tv(a,s)}}}},Vt=$s.registerPlugin({name:"attr",init:function(e,t,n,i,s){var o,a,l;this.tween=n;for(o in t)l=e.getAttribute(o)||"",a=this.add(e,"setAttribute",(l||0)+"",t[o],i,s,0,0,o),a.op=o,a.b=l,this._props.push(o)},render:function(e,t){for(var n=t._pt;n;)Ct?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:"endArray",init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},$a("roundProps",vo),$a("modifiers"),$a("snap",qu))||$s;ft.version=Ft.version=Vt.version="3.12.2";Lu=1;Oo()&&br();We.Power0;We.Power1;We.Power2;We.Power3;We.Power4;We.Linear;We.Quad;We.Cubic;We.Quart;We.Quint;We.Strong;We.Elastic;We.Back;We.SteppedEase;We.Bounce;We.Sine;We.Expo;We.Circ;/*!
 * CSSPlugin 3.12.2
 * https://greensock.com
 *
 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Fc,$n,_r,Yo,Ei,Bc,jo,nv=function(){return typeof window<"u"},Hn={},gi=180/Math.PI,gr=Math.PI/180,ir=Math.atan2,zc=1e8,Ko=/([A-Z])/g,iv=/(left|right|width|margin|padding|x)/i,rv=/[\s,\(]\S/,Tn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},So=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},sv=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},av=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},ov=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},dh=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},ph=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},lv=function(e,t,n){return e.style[t]=n},cv=function(e,t,n){return e.style.setProperty(t,n)},uv=function(e,t,n){return e._gsap[t]=n},hv=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},fv=function(e,t,n,i,s){var o=e._gsap;o.scaleX=o.scaleY=n,o.renderTransform(s,o)},dv=function(e,t,n,i,s){var o=e._gsap;o[t]=n,o.renderTransform(s,o)},tt="transform",vn=tt+"Origin",pv=function r(e,t){var n=this,i=this.target,s=i.style;if(e in Hn&&s){if(this.tfm=this.tfm||{},e!=="transform")e=Tn[e]||e,~e.indexOf(",")?e.split(",").forEach(function(o){return n.tfm[o]=On(i,o)}):this.tfm[e]=i._gsap.x?i._gsap[e]:On(i,e);else return Tn.transform.split(",").forEach(function(o){return r.call(n,o,t)});if(this.props.indexOf(tt)>=0)return;i._gsap.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(vn,t,"")),e=tt}(s||t)&&this.props.push(e,t,s[e])},mh=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},mv=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,s,o;for(s=0;s<e.length;s+=3)e[s+1]?t[e[s]]=e[s+2]:e[s+2]?n[e[s]]=e[s+2]:n.removeProperty(e[s].substr(0,2)==="--"?e[s]:e[s].replace(Ko,"-$1").toLowerCase());if(this.tfm){for(o in this.tfm)i[o]=this.tfm[o];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),s=jo(),(!s||!s.isStart)&&!n[tt]&&(mh(n),i.uncache=1)}},_h=function(e,t){var n={target:e,props:[],revert:mv,save:pv};return e._gsap||Vt.core.getCache(e),t&&t.split(",").forEach(function(i){return n.save(i)}),n},gh,Eo=function(e,t){var n=$n.createElementNS?$n.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):$n.createElement(e);return n.style?n:$n.createElement(e)},An=function r(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(Ko,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&r(e,Ar(t)||t,1)||""},Gc="O,Moz,ms,Ms,Webkit".split(","),Ar=function(e,t,n){var i=t||Ei,s=i.style,o=5;if(e in s&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);o--&&!(Gc[o]+e in s););return o<0?null:(o===3?"ms":o>=0?Gc[o]:"")+e},yo=function(){nv()&&window.document&&(Fc=window,$n=Fc.document,_r=$n.documentElement,Ei=Eo("div")||{style:{}},Eo("div"),tt=Ar(tt),vn=tt+"Origin",Ei.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",gh=!!Ar("perspective"),jo=Vt.core.reverting,Yo=1)},Ja=function r(e){var t=Eo("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,s=this.style.cssText,o;if(_r.appendChild(t),t.appendChild(this),this.style.display="block",e)try{o=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=r}catch{}else this._gsapBBox&&(o=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),_r.removeChild(t),this.style.cssText=s,o},Hc=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},vh=function(e){var t;try{t=e.getBBox()}catch{t=Ja.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===Ja||(t=Ja.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+Hc(e,["x","cx","x1"])||0,y:+Hc(e,["y","cy","y1"])||0,width:0,height:0}:t},xh=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&vh(e))},es=function(e,t){if(t){var n=e.style;t in Hn&&t!==vn&&(t=tt),n.removeProperty?((t.substr(0,2)==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(t.replace(Ko,"-$1").toLowerCase())):n.removeAttribute(t)}},Jn=function(e,t,n,i,s,o){var a=new kt(e._pt,t,n,0,1,o?ph:dh);return e._pt=a,a.b=i,a.e=s,e._props.push(n),a},kc={deg:1,rad:1,turn:1},_v={grid:1,flex:1},ai=function r(e,t,n,i){var s=parseFloat(n)||0,o=(n+"").trim().substr((s+"").length)||"px",a=Ei.style,l=iv.test(t),c=e.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,f=i==="px",m=i==="%",g,_,p,d;return i===o||!s||kc[i]||kc[o]?s:(o!=="px"&&!f&&(s=r(e,t,n,"px")),d=e.getCTM&&xh(e),(m||o==="%")&&(Hn[t]||~t.indexOf("adius"))?(g=d?e.getBBox()[l?"width":"height"]:e[u],ot(m?s/g*h:s/100*g)):(a[l?"width":"height"]=h+(f?o:i),_=~t.indexOf("adius")||i==="em"&&e.appendChild&&!c?e:e.parentNode,d&&(_=(e.ownerSVGElement||{}).parentNode),(!_||_===$n||!_.appendChild)&&(_=$n.body),p=_._gsap,p&&m&&p.width&&l&&p.time===Kt.time&&!p.uncache?ot(s/p.width*h):((m||o==="%")&&!_v[An(_,"display")]&&(a.position=An(e,"position")),_===e&&(a.position="static"),_.appendChild(Ei),g=Ei[u],_.removeChild(Ei),a.position="absolute",l&&m&&(p=wi(_),p.time=Kt.time,p.width=_[u]),ot(f?g*s/h:g&&s?h/g*s:0))))},On=function(e,t,n,i){var s;return Yo||yo(),t in Tn&&t!=="transform"&&(t=Tn[t],~t.indexOf(",")&&(t=t.split(",")[0])),Hn[t]&&t!=="transform"?(s=ns(e,i),s=t!=="transformOrigin"?s[t]:s.svg?s.origin:Qs(An(e,vn))+" "+s.zOrigin+"px"):(s=e.style[t],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Js[t]&&Js[t](e,t,n)||An(e,t)||Nu(e,t)||(t==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?ai(e,t,s,n)+n:s},gv=function(e,t,n,i){if(!n||n==="none"){var s=Ar(t,e,1),o=s&&An(e,s,1);o&&o!==n?(t=s,n=o):t==="borderColor"&&(n=An(e,"borderTopColor"))}var a=new kt(this._pt,e.style,t,0,1,uh),l=0,c=0,u,h,f,m,g,_,p,d,E,x,S,y;if(a.b=n,a.e=i,n+="",i+="",i==="auto"&&(e.style[t]=i,i=An(e,t)||i,e.style[t]=n),u=[n,i],eh(u),n=u[0],i=u[1],f=n.match(or)||[],y=i.match(or)||[],y.length){for(;h=or.exec(i);)p=h[0],E=i.substring(l,h.index),g?g=(g+1)%5:(E.substr(-5)==="rgba("||E.substr(-5)==="hsla(")&&(g=1),p!==(_=f[c++]||"")&&(m=parseFloat(_)||0,S=_.substr((m+"").length),p.charAt(1)==="="&&(p=mr(m,p)+S),d=parseFloat(p),x=p.substr((d+"").length),l=or.lastIndex-x.length,x||(x=x||$t.units[t]||S,l===i.length&&(i+=x,a.e+=x)),S!==x&&(m=ai(e,t,_,x)||0),a._pt={_next:a._pt,p:E||c===1?E:",",s:m,c:d-m,m:g&&g<4||t==="zIndex"?Math.round:0});a.c=l<i.length?i.substring(l,i.length):""}else a.r=t==="display"&&i==="none"?ph:dh;return Cu.test(i)&&(a.e=0),this._pt=a,a},Vc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},vv=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=Vc[n]||n,t[1]=Vc[i]||i,t.join(" ")},xv=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,s=t.u,o=n._gsap,a,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)a=s[c],Hn[a]&&(l=1,a=a==="transformOrigin"?vn:tt),es(n,a);l&&(es(n,tt),o&&(o.svg&&n.removeAttribute("transform"),ns(n,1),o.uncache=1,mh(i)))}},Js={clearProps:function(e,t,n,i,s){if(s.data!=="isFromStart"){var o=e._pt=new kt(e._pt,t,n,0,0,xv);return o.u=i,o.pr=-10,o.tween=s,e._props.push(n),1}}},ts=[1,0,0,1,0,0],Mh={},Sh=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Wc=function(e){var t=An(e,tt);return Sh(t)?ts:t.substr(7).match(Ru).map(ot)},Zo=function(e,t){var n=e._gsap||wi(e),i=e.style,s=Wc(e),o,a,l,c;return n.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?ts:s):(s===ts&&!e.offsetParent&&e!==_r&&!n.svg&&(l=i.display,i.display="block",o=e.parentNode,(!o||!e.offsetParent)&&(c=1,a=e.nextElementSibling,_r.appendChild(e)),s=Wc(e),l?i.display=l:es(e,"display"),c&&(a?o.insertBefore(e,a):o?o.appendChild(e):_r.removeChild(e))),t&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},To=function(e,t,n,i,s,o){var a=e._gsap,l=s||Zo(e,!0),c=a.xOrigin||0,u=a.yOrigin||0,h=a.xOffset||0,f=a.yOffset||0,m=l[0],g=l[1],_=l[2],p=l[3],d=l[4],E=l[5],x=t.split(" "),S=parseFloat(x[0])||0,y=parseFloat(x[1])||0,R,b,D,v;n?l!==ts&&(b=m*p-g*_)&&(D=S*(p/b)+y*(-_/b)+(_*E-p*d)/b,v=S*(-g/b)+y*(m/b)-(m*E-g*d)/b,S=D,y=v):(R=vh(e),S=R.x+(~x[0].indexOf("%")?S/100*R.width:S),y=R.y+(~(x[1]||x[0]).indexOf("%")?y/100*R.height:y)),i||i!==!1&&a.smooth?(d=S-c,E=y-u,a.xOffset=h+(d*m+E*_)-d,a.yOffset=f+(d*g+E*p)-E):a.xOffset=a.yOffset=0,a.xOrigin=S,a.yOrigin=y,a.smooth=!!i,a.origin=t,a.originIsAbsolute=!!n,e.style[vn]="0px 0px",o&&(Jn(o,a,"xOrigin",c,S),Jn(o,a,"yOrigin",u,y),Jn(o,a,"xOffset",h,a.xOffset),Jn(o,a,"yOffset",f,a.yOffset)),e.setAttribute("data-svg-origin",S+" "+y)},ns=function(e,t){var n=e._gsap||new rh(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,s=n.scaleX<0,o="px",a="deg",l=getComputedStyle(e),c=An(e,vn)||"0",u,h,f,m,g,_,p,d,E,x,S,y,R,b,D,v,A,z,q,j,P,O,X,k,J,$,K,U,H,ce,oe,ue;return u=h=f=_=p=d=E=x=S=0,m=g=1,n.svg=!!(e.getCTM&&xh(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[tt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[tt]!=="none"?l[tt]:"")),i.scale=i.rotate=i.translate="none"),b=Zo(e,n.svg),n.svg&&(n.uncache?(J=e.getBBox(),c=n.xOrigin-J.x+"px "+(n.yOrigin-J.y)+"px",k=""):k=!t&&e.getAttribute("data-svg-origin"),To(e,k||c,!!k||n.originIsAbsolute,n.smooth!==!1,b)),y=n.xOrigin||0,R=n.yOrigin||0,b!==ts&&(z=b[0],q=b[1],j=b[2],P=b[3],u=O=b[4],h=X=b[5],b.length===6?(m=Math.sqrt(z*z+q*q),g=Math.sqrt(P*P+j*j),_=z||q?ir(q,z)*gi:0,E=j||P?ir(j,P)*gi+_:0,E&&(g*=Math.abs(Math.cos(E*gr))),n.svg&&(u-=y-(y*z+R*j),h-=R-(y*q+R*P))):(ue=b[6],ce=b[7],K=b[8],U=b[9],H=b[10],oe=b[11],u=b[12],h=b[13],f=b[14],D=ir(ue,H),p=D*gi,D&&(v=Math.cos(-D),A=Math.sin(-D),k=O*v+K*A,J=X*v+U*A,$=ue*v+H*A,K=O*-A+K*v,U=X*-A+U*v,H=ue*-A+H*v,oe=ce*-A+oe*v,O=k,X=J,ue=$),D=ir(-j,H),d=D*gi,D&&(v=Math.cos(-D),A=Math.sin(-D),k=z*v-K*A,J=q*v-U*A,$=j*v-H*A,oe=P*A+oe*v,z=k,q=J,j=$),D=ir(q,z),_=D*gi,D&&(v=Math.cos(D),A=Math.sin(D),k=z*v+q*A,J=O*v+X*A,q=q*v-z*A,X=X*v-O*A,z=k,O=J),p&&Math.abs(p)+Math.abs(_)>359.9&&(p=_=0,d=180-d),m=ot(Math.sqrt(z*z+q*q+j*j)),g=ot(Math.sqrt(X*X+ue*ue)),D=ir(O,X),E=Math.abs(D)>2e-4?D*gi:0,S=oe?1/(oe<0?-oe:oe):0),n.svg&&(k=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Sh(An(e,tt)),k&&e.setAttribute("transform",k))),Math.abs(E)>90&&Math.abs(E)<270&&(s?(m*=-1,E+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,E+=E<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+o,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+o,n.z=f+o,n.scaleX=ot(m),n.scaleY=ot(g),n.rotation=ot(_)+a,n.rotationX=ot(p)+a,n.rotationY=ot(d)+a,n.skewX=E+a,n.skewY=x+a,n.transformPerspective=S+o,(n.zOrigin=parseFloat(c.split(" ")[2])||0)&&(i[vn]=Qs(c)),n.xOffset=n.yOffset=0,n.force3D=$t.force3D,n.renderTransform=n.svg?Sv:gh?Eh:Mv,n.uncache=0,n},Qs=function(e){return(e=e.split(" "))[0]+" "+e[1]},Qa=function(e,t,n){var i=Rt(t);return ot(parseFloat(t)+parseFloat(ai(e,"x",n+"px",i)))+i},Mv=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Eh(e,t)},pi="0deg",Nr="0px",mi=") ",Eh=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,o=n.x,a=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,m=n.skewY,g=n.scaleX,_=n.scaleY,p=n.transformPerspective,d=n.force3D,E=n.target,x=n.zOrigin,S="",y=d==="auto"&&e&&e!==1||d===!0;if(x&&(h!==pi||u!==pi)){var R=parseFloat(u)*gr,b=Math.sin(R),D=Math.cos(R),v;R=parseFloat(h)*gr,v=Math.cos(R),o=Qa(E,o,b*v*-x),a=Qa(E,a,-Math.sin(R)*-x),l=Qa(E,l,D*v*-x+x)}p!==Nr&&(S+="perspective("+p+mi),(i||s)&&(S+="translate("+i+"%, "+s+"%) "),(y||o!==Nr||a!==Nr||l!==Nr)&&(S+=l!==Nr||y?"translate3d("+o+", "+a+", "+l+") ":"translate("+o+", "+a+mi),c!==pi&&(S+="rotate("+c+mi),u!==pi&&(S+="rotateY("+u+mi),h!==pi&&(S+="rotateX("+h+mi),(f!==pi||m!==pi)&&(S+="skew("+f+", "+m+mi),(g!==1||_!==1)&&(S+="scale("+g+", "+_+mi),E.style[tt]=S||"translate(0, 0)"},Sv=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,o=n.x,a=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,m=n.target,g=n.xOrigin,_=n.yOrigin,p=n.xOffset,d=n.yOffset,E=n.forceCSS,x=parseFloat(o),S=parseFloat(a),y,R,b,D,v;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=gr,c*=gr,y=Math.cos(l)*h,R=Math.sin(l)*h,b=Math.sin(l-c)*-f,D=Math.cos(l-c)*f,c&&(u*=gr,v=Math.tan(c-u),v=Math.sqrt(1+v*v),b*=v,D*=v,u&&(v=Math.tan(u),v=Math.sqrt(1+v*v),y*=v,R*=v)),y=ot(y),R=ot(R),b=ot(b),D=ot(D)):(y=h,D=f,R=b=0),(x&&!~(o+"").indexOf("px")||S&&!~(a+"").indexOf("px"))&&(x=ai(m,"x",o,"px"),S=ai(m,"y",a,"px")),(g||_||p||d)&&(x=ot(x+g-(g*y+_*b)+p),S=ot(S+_-(g*R+_*D)+d)),(i||s)&&(v=m.getBBox(),x=ot(x+i/100*v.width),S=ot(S+s/100*v.height)),v="matrix("+y+","+R+","+b+","+D+","+x+","+S+")",m.setAttribute("transform",v),E&&(m.style[tt]=v)},Ev=function(e,t,n,i,s){var o=360,a=xt(s),l=parseFloat(s)*(a&&~s.indexOf("rad")?gi:1),c=l-i,u=i+c+"deg",h,f;return a&&(h=s.split("_")[1],h==="short"&&(c%=o,c!==c%(o/2)&&(c+=c<0?o:-o)),h==="cw"&&c<0?c=(c+o*zc)%o-~~(c/o)*o:h==="ccw"&&c>0&&(c=(c-o*zc)%o-~~(c/o)*o)),e._pt=f=new kt(e._pt,t,n,i,c,sv),f.e=u,f.u="deg",e._props.push(n),f},Xc=function(e,t){for(var n in t)e[n]=t[n];return e},yv=function(e,t,n){var i=Xc({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",o=n.style,a,l,c,u,h,f,m,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),o[tt]=t,a=ns(n,1),es(n,tt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[tt],o[tt]=t,a=ns(n,1),o[tt]=c);for(l in Hn)c=i[l],u=a[l],c!==u&&s.indexOf(l)<0&&(m=Rt(c),g=Rt(u),h=m!==g?ai(n,l,c,g):parseFloat(c),f=parseFloat(u),e._pt=new kt(e._pt,a,l,h,f-h,So),e._pt.u=g||0,e._props.push(l));Xc(a,i)};Ht("padding,margin,Width,Radius",function(r,e){var t="Top",n="Right",i="Bottom",s="Left",o=(e<3?[t,n,i,s]:[t+s,t+n,i+n,i+s]).map(function(a){return e<2?r+a:"border"+a+r});Js[e>1?"border"+r:r]=function(a,l,c,u,h){var f,m;if(arguments.length<4)return f=o.map(function(g){return On(a,g,c)}),m=f.join(" "),m.split(f[0]).length===5?f[0]:m;f=(u+"").split(" "),m={},o.forEach(function(g,_){return m[g]=f[_]=f[_]||f[(_-1)/2|0]}),a.init(l,m,h)}});var yh={name:"css",register:yo,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,s){var o=this._props,a=e.style,l=n.vars.startAt,c,u,h,f,m,g,_,p,d,E,x,S,y,R,b,D;Yo||yo(),this.styles=this.styles||_h(e),D=this.styles.props,this.tween=n;for(_ in t)if(_!=="autoRound"&&(u=t[_],!(jt[_]&&sh(_,t,n,i,e,s)))){if(m=typeof u,g=Js[_],m==="function"&&(u=u.call(n,i,e,s),m=typeof u),m==="string"&&~u.indexOf("random(")&&(u=$r(u)),g)g(this,e,_,u,n)&&(b=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(_)+"").trim(),u+="",ii.lastIndex=0,ii.test(c)||(p=Rt(c),d=Rt(u)),d?p!==d&&(c=ai(e,_,c,d)+d):p&&(u+=p),this.add(a,"setProperty",c,u,i,s,0,0,_),o.push(_),D.push(_,0,a[_]);else if(m!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,e,s):l[_],xt(c)&&~c.indexOf("random(")&&(c=$r(c)),Rt(c+"")||(c+=$t.units[_]||Rt(On(e,_))||""),(c+"").charAt(1)==="="&&(c=On(e,_))):c=On(e,_),f=parseFloat(c),E=m==="string"&&u.charAt(1)==="="&&u.substr(0,2),E&&(u=u.substr(2)),h=parseFloat(u),_ in Tn&&(_==="autoAlpha"&&(f===1&&On(e,"visibility")==="hidden"&&h&&(f=0),D.push("visibility",0,a.visibility),Jn(this,a,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=Tn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),x=_ in Hn,x){if(this.styles.save(_),S||(y=e._gsap,y.renderTransform&&!t.parseTransform||ns(e,t.parseTransform),R=t.smoothOrigin!==!1&&y.smooth,S=this._pt=new kt(this._pt,a,tt,0,1,y.renderTransform,y,0,-1),S.dep=1),_==="scale")this._pt=new kt(this._pt,y,"scaleY",y.scaleY,(E?mr(y.scaleY,E+h):h)-y.scaleY||0,So),this._pt.u=0,o.push("scaleY",_),_+="X";else if(_==="transformOrigin"){D.push(vn,0,a[vn]),u=vv(u),y.svg?To(e,u,0,R,0,this):(d=parseFloat(u.split(" ")[2])||0,d!==y.zOrigin&&Jn(this,y,"zOrigin",y.zOrigin,d),Jn(this,a,_,Qs(c),Qs(u)));continue}else if(_==="svgOrigin"){To(e,u,1,R,0,this);continue}else if(_ in Mh){Ev(this,y,_,f,E?mr(f,E+u):u);continue}else if(_==="smoothOrigin"){Jn(this,y,"smooth",y.smooth,u);continue}else if(_==="force3D"){y[_]=u;continue}else if(_==="transform"){yv(this,u,e);continue}}else _ in a||(_=Ar(_)||_);if(x||(h||h===0)&&(f||f===0)&&!rv.test(u)&&_ in a)p=(c+"").substr((f+"").length),h||(h=0),d=Rt(u)||(_ in $t.units?$t.units[_]:p),p!==d&&(f=ai(e,_,c,d)),this._pt=new kt(this._pt,x?y:a,_,f,(E?mr(f,E+h):h)-f,!x&&(d==="px"||_==="zIndex")&&t.autoRound!==!1?ov:So),this._pt.u=d||0,p!==d&&d!=="%"&&(this._pt.b=c,this._pt.r=av);else if(_ in a)gv.call(this,e,_,c,E?E+u:u);else if(_ in e)this.add(e,_,c||e[_],E?E+u:u,i,s);else if(_!=="parseTransform"){Bo(_,u);continue}x||(_ in a?D.push(_,0,a[_]):D.push(_,1,c||e[_])),o.push(_)}}b&&hh(this)},render:function(e,t){if(t.tween._time||!jo())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:On,aliases:Tn,getSetter:function(e,t,n){var i=Tn[t];return i&&i.indexOf(",")<0&&(t=i),t in Hn&&t!==vn&&(e._gsap.x||On(e,"x"))?n&&Bc===n?t==="scale"?hv:uv:(Bc=n||{})&&(t==="scale"?fv:dv):e.style&&!No(e.style[t])?lv:~t.indexOf("-")?cv:Xo(e,t)},core:{_removeProperty:es,_getMatrix:Zo}};Vt.utils.checkPrefix=Ar;Vt.core.getStyleSaver=_h;(function(r,e,t,n){var i=Ht(r+","+e+","+t,function(s){Hn[s]=1});Ht(e,function(s){$t.units[s]="deg",Mh[s]=1}),Tn[i[13]]=r+","+e,Ht(n,function(s){var o=s.split(":");Tn[o[1]]=i[o[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Ht("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){$t.units[r]="px"});Vt.registerPlugin(yh);var Li=Vt.registerPlugin(yh)||Vt;Li.core.Tween;const cr=document.querySelector("canvas");let Pe,pe;Pe=window.innerWidth>=1024?document.documentElement.scrollLeft/window.innerWidth:document.documentElement.scrollTop/window.innerHeight;const at=document.querySelector("#section-container"),Tv=document.getElementById("1-2-button"),bv=document.getElementById("2-1-button"),Av=document.getElementById("2-3-button"),wv=document.getElementById("3-2-button"),qc=[Tv,bv,Av,wv],is=document.querySelector("#up-button"),rs=document.querySelector("#down-button"),Yc=[is,rs],ea=document.querySelector("header"),ta=document.querySelector("footer");let bo=!0;const $o=new n0,vt=new a0,Rv=[vt.load("/css/assets/img/webdev/svelte.png"),vt.load("/css/assets/img/webdev/css.png"),vt.load("/css/assets/img/webdev/html.png"),vt.load("/css/assets/img/webdev/javascript.png"),vt.load("/css/assets/img/webdev/three-js.png"),vt.load("/css/assets/img/webdev/tailwind-css.png")],Cv=[vt.load("/css/assets/img/gaming/bootleg-games-wiki.png"),vt.load("/css/assets/img/gaming/bootleg-games-wiki.png"),vt.load("/css/assets/img/gaming/forever-classic-games.png"),vt.load("/css/assets/img/gaming/forever-classic-games.png"),vt.load("/css/assets/img/gaming/mega-cat.png"),vt.load("/css/assets/img/gaming/mega-cat.png")],Pv=[vt.load("/css/assets/img/translation/metal-gear.png"),vt.load("/css/assets/img/translation/metal-gear.png"),vt.load("/css/assets/img/translation/resident-evil.png"),vt.load("/css/assets/img/translation/resident-evil.png"),vt.load("/css/assets/img/translation/ninja-gaiden.png"),vt.load("/css/assets/img/translation/ninja-gaiden.png")],Th=[Rv,Cv,Pv],Lv=(r,e)=>{const t=new ar,n=r*e,i=[];if(r%2==1){let s=0;i.push(s);for(let o=0;o<Math.floor(r/2);o++)s+=e,i.reverse(),i.push(s),i.reverse(),i.push(-s);i.reverse()}else{let s=e/2;i.push(s),i.push(-s);for(let o=0;o<r/2-1;o++)s+=e,i.reverse(),i.push(s),i.reverse(),i.push(-s);i.reverse()}for(let s=0;s<6;s++){const o=new ar;for(let a=0;a<r;a++)for(let l=0;l<r;l++){const c=new aa(e,e),u=new Lo({side:En,transparent:!0,opacity:1}),h=new Bn(c,u);h.position.x=i[a],h.position.y=i[l],o.add(h)}switch(o.userData.id=s,s){case 0:o.position.y=n/2,o.rotation.x=-Math.PI/2;break;case 1:o.position.y=-n/2,o.rotation.x=Math.PI/2;break;case 2:o.position.z=n/2;break;case 3:o.position.z=-n/2,o.rotation.y=Math.PI;break;case 4:o.position.x=-n/2,o.rotation.y=-Math.PI/2;break;case 5:o.position.x=n/2,o.rotation.y=Math.PI/2}t.add(o)}return t},bh=(r,e)=>{for(let t=0;t<6;t++){const n=e.children[t],i=Math.sqrt(n.children.length),s=[];let o=-1/i;for(let a=0;a<i;a++){o+=1/i;let l=-1/i;for(let c=0;c<i;c++)l+=1/i,s.push([o,l])}if(t==n.userData.id)for(let a=0;a<n.children.length;a++){const l=n.children[a];l.material.map=r[t].clone(),l.material.map.needsUpdate=!0,l.material.map.offset.x=s[a][0],l.material.map.offset.y=s[a][1],l.material.map.repeat.x=1/i,l.material.map.repeat.y=1/i}}},Dv=r=>{const e=[];for(let t=0;t<r.children.length;t++){const n=r.children[t];for(let i=0;i<n.children.length;i++){const s=n.children[i];e.push({x:s.position.x,y:s.position.y,z:s.position.z})}}return e},Uv=(r,e)=>{for(let t=0;t<r.children.length;t++){const n=r.children[t];for(let i=0;i<n.children.length;i++){const s=n.children[i],o=50*Math.random(),a=50*Math.random(),l=50*Math.random();Li.to(s.position,{duration:e,ease:"power4.in",x:o,y:a,z:l});const c=5*Math.random(),u=5*Math.random(),h=5*Math.random();Li.to(s.rotation,{duration:e,ease:"power4.in",x:c,y:u,z:h}),Li.to(s.material,{duration:e,ease:"power4.in",opacity:0})}}},Iv=(r,e,t)=>{for(let n=0;n<r.children.length;n++){const i=r.children[n];for(let s=0;s<i.children.length;s++){const o=i.children[s];Li.to(o.position,{duration:e,ease:"power4.out",x:t[s].x,y:t[s].y,z:t[s].z}),Li.to(o.rotation,{duration:e,ease:"power4.out",x:0,y:0,z:0}),Li.to(o.material,{duration:e,ease:"power4.out",opacity:1})}}},ur=(r,e,t)=>{Uv(r,e),bo=!1,setTimeout(()=>{bh(Th[t],r),Iv(r,e,Fv),bo=!0},1e3*e)},zs=r=>{r==1?(cr.classList.remove("md:-translate-x-1/3"),cr.classList.add("md:translate-x-0")):(cr.classList.remove("md:translate-x-0"),cr.classList.add("md:-translate-x-1/3"))},Mi=()=>{for(let r=0;r<at.childElementCount;r++)at.children[r].classList.remove("opacity-100"),at.children[r].classList.add("opacity-0")},Si=r=>{at.children[r].classList.remove("opacity-0"),at.children[r].classList.add("opacity-100")},Xr=()=>{is.classList.remove("-top-16"),is.classList.add("top-0"),rs.classList.remove("-bottom-16"),rs.classList.add("bottom-0")},hr=()=>{is.classList.remove("top-0"),is.classList.add("-top-16")},fr=()=>{rs.classList.remove("bottom-0"),rs.classList.add("-bottom-16")},Nv=r=>{const e=r.textContent.trim();let t="";for(let n=0;n<e.length;n++)t+=`<span class="inline-flex transition-transform duration-1000 ease-in-out">${e[n]}</span>`;r.innerHTML=t},Nt=r=>{const e=document.querySelectorAll("h3");for(let n=0;n<e.length;n++){const i=e[n];for(let s=0;s<i.childElementCount;s++){const o=i.children[s];o.style.transform="rotateX(180deg)"}}const t=document.querySelector(`section:nth-child(${r+1}) > h3`);for(let n=0;n<t.childElementCount;n++){const i=t.children[n];setTimeout(()=>{i.style.transform="rotateX(360deg)"},50*n)}},Ah=()=>{const r=document.querySelectorAll(".h-screen");for(let e=0;e<r.length;e++){const t=r[e];t.style.height=`${window.innerHeight}px`}};Ah();const jc=document.querySelectorAll("h3");for(let r=0;r<jc.length;r++){const e=jc[r];Nv(e)}for(let r=0;r<qc.length;r++)qc[r].addEventListener("click",()=>{r==0?(Pe+=1,at.scrollIntoView({behavior:"smooth"}),Nt(pe)):r==1?(Pe-=1,ea.scrollIntoView({behavior:"smooth"})):r==2?(Pe+=1,ta.scrollIntoView({behavior:"smooth"})):r==3&&(Pe-=1,at.scrollIntoView({behavior:"smooth"}),Nt(pe))});Xr(),Pe==0?hr():Pe==2&&fr();for(let r=0;r<Yc.length;r++)Yc[r].addEventListener("click",()=>{Xr(),r==0?Pe==2?(Pe-=1,at.scrollIntoView({behavior:"smooth"}),Nt(pe)):Pe==1&&pe!=0?(pe-=1,ur(on,.5,pe),Mi(),Si(pe),Nt(pe),at.children[pe].scrollIntoView({behavior:"smooth"})):Pe==1&&pe==0&&(Pe-=1,ea.scrollIntoView({behavior:"smooth"}),hr()):r==1&&(Pe==0?(Pe+=1,at.scrollIntoView({behavior:"smooth"}),Nt(pe)):Pe==1&&pe!=2?(pe+=1,ur(on,.5,pe),Mi(),Si(pe),Nt(pe),at.children[pe].scrollIntoView({behavior:"smooth"})):Pe==1&&pe==2&&(Pe+=1,ta.scrollIntoView({behavior:"smooth"}),fr())),zs(pe)});const Ov=document.querySelector("#code-block");for(let r=0;r<7;r++){let e="<div>";for(let t=0;t<Math.ceil(7*(Math.random()+.25));t++)Math.random()<.5?e+='<span class="code">0</span>':e+='<span class="code font-bold">1</span>';e+="</div>",Ov.innerHTML+=e}const Kc=document.querySelectorAll(".code");for(let r=0;r<Kc.length;r++){const e=Kc[r],t=2e3*(Math.random()+.5);setInterval(()=>{e.textContent=="1"?e.textContent="0":e.textContent="1"},t)}const on=Lv(4,.45);$o.add(on);const Fv=Dv(on);pe=at.scrollTop/window.innerHeight,bh(Th[pe],on),Mi(),Si(pe),Nt(pe),zs(pe),window.addEventListener("wheel",r=>{const e=r.deltaY;Xr(),e>0?Pe==0?(Pe+=1,at.scrollIntoView({behavior:"smooth"}),Nt(pe)):Pe==1&&pe!=2?(pe+=1,ur(on,.5,pe),Mi(),Si(pe),Nt(pe),at.children[pe].scrollIntoView({behavior:"smooth"})):Pe==1&&pe==2?(Pe+=1,ta.scrollIntoView({behavior:"smooth"}),fr()):Pe==2&&fr():e<0&&(Pe==2?(Pe-=1,at.scrollIntoView({behavior:"smooth"}),Nt(pe)):Pe==1&&pe!=0?(pe-=1,ur(on,.5,pe),Mi(),Si(pe),Nt(pe),at.children[pe].scrollIntoView({behavior:"smooth"})):Pe==1&&pe==0?(Pe-=1,ea.scrollIntoView({behavior:"smooth"}),hr()):Pe==0&&hr()),zs(pe)}),window.addEventListener("keyup",r=>{const e=r.key;e=="ArrowDown"||e=="PageDown"?(Xr(),Pe==0?(Pe+=1,at.scrollIntoView({behavior:"smooth"}),Nt(pe)):Pe==1&&pe!=2?(pe+=1,ur(on,.5,pe),Mi(),Si(pe),Nt(pe),at.children[pe].scrollIntoView({behavior:"smooth"})):Pe==1&&pe==2?(Pe+=1,ta.scrollIntoView({behavior:"smooth"}),fr()):Pe==2&&fr()):e!="ArrowUp"&&e!="PageUp"||(Xr(),Pe==2?(Pe-=1,at.scrollIntoView({behavior:"smooth"}),Nt(pe)):Pe==1&&pe!=0?(pe-=1,ur(on,.5,pe),Mi(),Si(pe),Nt(pe),at.children[pe].scrollIntoView({behavior:"smooth"})):Pe==1&&pe==0?(Pe-=1,ea.scrollIntoView({behavior:"smooth"}),hr()):Pe==0&&hr()),zs(pe)}),window.addEventListener("resize",()=>{Sn.width=1.5*window.innerWidth,Sn.height=window.innerHeight,Ah(),at.scrollTop=pe*window.innerHeight,window.innerWidth>=1024?document.documentElement.scrollLeft=Pe*window.innerWidth:document.documentElement.scrollTop=Pe*window.innerHeight,wr.aspect=Sn.width/Sn.height,wr.updateProjectionMatrix(),ss.setSize(Sn.width,Sn.height),ss.setPixelRatio(Math.min(window.devicePixelRatio,2))});const Sn={width:1.5*window.innerWidth,height:window.innerHeight},wr=new sn(75,Sn.width/Sn.height,.1,100);wr.position.z=4,$o.add(wr);const wh=new c0(wr,cr);wh.enableDamping=!0;const ss=new Tu({canvas:cr});ss.setSize(Sn.width,Sn.height),ss.setClearColor(986895);const Bv=new o0,Rh=()=>{const r=Bv.getElapsedTime();if(bo){const e=.125*r,t=.25*r,n=r;on.rotation.x=e,on.rotation.y=t,on.rotation.z=n}wh.update(),ss.render($o,wr),window.requestAnimationFrame(Rh)};Rh();
